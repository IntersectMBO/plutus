"use strict";
(globalThis["webpackChunkdocusaurus"] = globalThis["webpackChunkdocusaurus"] || []).push([[7587],{
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["There are several different notions of version that Cardano smart contract developers must distinguish.\nFor each Plutus script that is deployed on-chain, its execution behavior depends on protocol version, ledger language version and Plutus Core version (as well as the ", (0,jsx_runtime.jsx)(_components.a, {
        href: "../delve-deeper/cost-model",
        children: "cost model"
      }), ")).\nThese all influence which syntax and semantics are available for UPLC scripts."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The ledger language version and Plutus Core version can be chosen by the script developer, while the protocol version is only changed by on-chain governance.\nTo develop for a given ledger language in Plinth, say PlutusV3, import the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "PlutusLedgerApi.V3"
      }), " module from the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "plutus-ledger-api"
      }), " package.\nTo control the Plutus Core version that Plinth targets, set the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "target-version"
      }), " ", (0,jsx_runtime.jsx)(_components.a, {
        href: "../delve-deeper/plinth-compiler-options",
      ...
      children: ["The protocol version (PV) is a protocol parameter of the form ", (0,jsx_runtime.jsx)(_components.code, {
        children: "MAJOR.MINOR"
      }), ", which is the main factor for determining available features and behavior of the chain.\nThat behavior is implemented in the node software (which includes the Plutus Core evaluator).\nFor example, starting with PV 11, the semantics of PlutusV3 + UPLC 1.1.0 is extended with ", (0,jsx_runtime.jsx)(_components.a, {
        href: "../delve-deeper/casing-constants",
        children: "casing on constants"
      }), ".\nThis feature does not affect execution of older scripts, as the UPLC interpreter takes the associated PV into account."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Changes to protocol parameters are agreed upon by the decentralized governance model. A hard fork bumps the major part of the protocol version.\nFor more detail, see the ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://developers.cardano.org/docs/governance/cardano-governance/",
        children: "Cardano Developer Portal"
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "builtin-semantics-variant",
