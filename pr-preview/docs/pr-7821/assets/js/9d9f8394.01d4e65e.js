"use strict";
(globalThis["webpackChunkdocusaurus"] = globalThis["webpackChunkdocusaurus"] || []).push([[9013],{
...
const site_docs_troubleshooting_md_9d9_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"troubleshooting","title":"Troubleshooting","description":"Compilation Errors","source":"@site/docs/troubleshooting.md","sourceDirName":".","slug":"/troubleshooting","permalink":"/pr-preview/docs/pr-7821/troubleshooting","draft":false,"unlisted":false,"editUrl":"https://github.com/IntersectMBO/plutus/edit/master/doc/docusaurus/docs/troubleshooting.md","tags":[],"version":"current","sidebarPosition":80,"frontMatter":{"sidebar_position":80},"sidebar":"tutorialSidebar","previous":{"title":"Builtin Arrays","permalink":"/pr-preview/docs/pr-7821/upcoming-features/builtin-arrays"}}');
...
const toc = [{
  ...
  "value": "1. Direct Construction of Builtin Types",
  "id": "1-direct-construction-of-builtin-types",
  "level": 4
}, {
  "value": "2. Stage Violation with Where-Bindings",
  "id": "2-stage-violation-with-where-bindings",
  "level": 4
}, {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["If this doesn't resolve the issue, or if the identifier in question isn't directly defined in the code but is produced by GHC optimizations,\nensure that you apply all GHC flags listed in ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/docs/pr-7821/using-plinth/extensions-flags-pragmas",
      ...
      children: ["This error can also occur if the definition of an identifier isn't available at compile time, as is the case with function parameters - e.g., ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        href: "/pr-preview/docs/pr-7821/using-plinth/lifting",
      ...
      children: "This error can occur in two main scenarios:"
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "1-direct-construction-of-builtin-types",
      children: "1. Direct Construction of Builtin Types"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["To convert a Haskell type to the corresponding builtin type in Plinth, you should use ", (0,jsx_runtime.jsx)(_components.code, {
        children: "toOpaque"
      ...
      id: "2-stage-violation-with-where-bindings",
      children: "2. Stage Violation with Where-Bindings"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["This error often appears when using where-bindings that reference builtin types within ", (0,jsx_runtime.jsx)(_components.code, {
        children: "compile"
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-haskell",
        children: "code = $$(compile [||validator||])\n  where\n    validator :: BuiltinUnit\n    validator = unitval\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "After GHC simplification, this becomes:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-haskell",
        children: "code = case unitval of\n  validator_X0 { BuiltinUnit ipv -> plc Proxy validator_X0 }\n"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The pattern match on the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "BuiltinUnit"
      }), " constructor cannot be compiled by Plinth because ", (0,jsx_runtime.jsx)(_components.code, {
        children: "BuiltinUnit"
      }), " (and other types like ", (0,jsx_runtime.jsx)(_components.code, {
        children: "BuiltinData"
      }), ", ", (0,jsx_runtime.jsx)(_components.code, {
        children: "BuiltinByteString"
      }), ", etc.) are opaque wrappers that only exist on the Haskell side—they have no corresponding constructors in Plutus IR."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: (0,jsx_runtime.jsx)(_components.strong, {
            children: "Move the binding to the top level:"
          })
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-haskell",
            children: "validator :: BuiltinUnit\nvalidator = unitval\n{-# INLINEABLE validator #-}\n\ncode = $$(compile [||validator||])\n"
          })
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: (0,jsx_runtime.jsxs)(_components.strong, {
            children: ["Use lazy bindings with tilde (", (0,jsx_runtime.jsx)(_components.code, {
              children: "~"
            }), "):"]
          })
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: (0,jsx_runtime.jsx)(_components.strong, {
            children: "Define the binding inside the quotation:"
          })
        }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
          children: (0,jsx_runtime.jsx)(_components.code, {
            className: "language-haskell",
            children: "code = $$(compile [|| let validator = unitval in validator ||])\n"
          })
        }), "\n"]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Variables inside ", (0,jsx_runtime.jsx)(_components.code, {
        children: "compile"
      }), " quotations must be either top-level, bound inside the quotation itself, or use lazy bindings (", (0,jsx_runtime.jsx)(_components.code, {
        children: "~"
      }), ") to avoid stage violations."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "runtime-issues",
      ...
      children: ["If your expected trace messages are missing, check the following ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/docs/pr-7821/delve-deeper/plinth-compiler-options",
