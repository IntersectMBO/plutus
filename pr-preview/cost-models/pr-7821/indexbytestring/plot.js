// IndexByteString plot configuration and rendering

// Configuration
const FUNCTION_NAME = 'IndexByteString';  // CSV uses PascalCase
...
function renderPlot() {
  // Prepare benchmark trace - use first argument (ByteString size) as X
