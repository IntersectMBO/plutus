// DecodeUtf8 plot configuration and rendering

// Configuration
const FUNCTION_NAME = 'DecodeUtf8';  // CSV uses PascalCase
const COST_MODEL_NAME = 'decodeUtf8';  // JSON uses camelCase
const ARITY = 1;
...
function renderPlot() {
  ...
  const layout = {
    ...
    xaxis: {
      title: 'ByteString size (byte-words)',
      gridcolor: '#E0E0E0'
    },
    yaxis: {
