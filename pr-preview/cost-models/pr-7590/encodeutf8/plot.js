// EncodeUtf8 plot configuration and rendering

// Configuration
const FUNCTION_NAME = 'EncodeUtf8';  // CSV uses PascalCase
const COST_MODEL_NAME = 'encodeUtf8';  // JSON uses camelCase
const ARITY = 1;
