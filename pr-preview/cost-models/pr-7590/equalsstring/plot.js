// EqualsString plot configuration and rendering (3D)

// Configuration
const FUNCTION_NAME = 'EqualsString';  // CSV uses PascalCase
const COST_MODEL_NAME = 'equalsString';  // JSON uses camelCase
const ARITY = 2;
...
function renderPlot() {
  ...
  const layout = {
    ...
    scene: {
      xaxis: {
        title: 'String 1 size (byte-words)',
        gridcolor: '#E0E0E0'
      },
      yaxis: {
        title: 'String 2 size (byte-words)',
        gridcolor: '#E0E0E0'
      },
      zaxis: {
