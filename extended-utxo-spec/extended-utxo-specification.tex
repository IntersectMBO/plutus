...
\item Each unspent output now has an object of type \Data{} associated
  with it: we call this the output's \textit{datum} (plural:
  \textit{datums}) (see \cref{note:datum}).  Only the hash
...
\paragraph{Scripts and hashes.} Note that datums and validators are
...
\cref{note:data-witnesses} for more discussion.
...
\item
  ...
  \begin{displaymath}
    ...
    i.\validator\rrbracket (i.\datum,\, i.\redeemerVal,\,  \toData(\mkContext(t,i,l))) = \true.
  \end{displaymath}
...
\item
  ...
  \begin{displaymath}
    \textrm{For all } i \in t.\inputs,\ \llbracket
    i.\validator\rrbracket(i.\datum,\, i.\redeemerVal,\, \toData_2(\mkContext_2(t, i, l))) = \true
  \end{displaymath}
...
The same strategy applies to datums.
