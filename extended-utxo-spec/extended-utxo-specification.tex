...
\item Validation of an output is performed by running the validator
  ...
  \item The \ptx{} structure, encoded as \Data{}.
  \end{enumerate}
...
but has the data value for the output in full.\footnote{See
...
validator script and the redeeemer value for the inputs.  The \i{thisInput}
...
\script{} values of the $\validator$, $\redeemerval$ and
$\dataval$ fields and the result of $\delta$. The validation of a
...
\textsf{OutputInfo} type includes the data values for the outputs
