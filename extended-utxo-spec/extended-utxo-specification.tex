...
native currency of the Cardano blockchain is Ada.
...
% We have assumed that our basic \qty{} type is the type of natural
% numbers.  However, the models mostly carry over to the case where
% \qty{} is an arbitrary abelian group.\footnote{In fact, this even
...
%   We can even replace \qty{} with a commutative
