...
The \ptx{} type is essentially a summary of the information contained
...
validator, and the hash of the data value.\footnote{See
  \cref{note:data-values-in-ptx} for further explanation.}  The
...
and redeemer values for the inputs.  The \i{thisInput} field
...
\item
  ...
  \textbf{Validators match output addresses}
  \begin{displaymath}
