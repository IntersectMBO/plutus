...
safeLift
    :: (Lift.Lift uni a
       ...
       , PLC.ToKind uni, PLC.HasUniApply uni, PLC.ToBuiltinMeaning uni fun
       )
...
lift
    :: (Lift.Lift uni a, Throwable uni fun, PLC.ToKind uni, PLC.HasUniApply uni, PLC.ToBuiltinMeaning uni fun)
