...
unsafely ::
  ...
  ExceptT (Error uni fun (Provenance ())) Quote a ->
  a
...
liftProgramDef ::
  ...
  a ->
  (PIR.Program PLC.TyName PLC.Name PLC.DefaultUni PLC.DefaultFun (), UPLC.Program UPLC.NamedDeBruijn PLC.DefaultUni PLC.DefaultFun ())
