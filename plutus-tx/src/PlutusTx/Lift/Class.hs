...
instance uni `PLC.Includes` Crypto.BLS12_381.G1.Element => Lift uni BuiltinBLS12_381_G1_Element where
    lift a = liftBuiltin $ fromBuiltin a

instance uni `PLC.Includes` Crypto.BLS12_381.G2.Element => Lift uni BuiltinBLS12_381_G2_Element where
    lift a = liftBuiltin $ fromBuiltin a

instance uni `PLC.Includes` Crypto.BLS12_381.Pairing.MlResult => Lift uni BuiltinBLS12_381_MlResult where
    lift a = liftBuiltin $ fromBuiltin a
