...
ckdata <- read.table("CK-times-fib", header=T)
cekdata  <- read.table("CEK-times-fib", header=T)
ldata <- read.table("L-times-fib", header=T)
ydata <- read.table("Y-times-fib", header=T)
