...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.3cm,>=stealth',bend angle=45,auto]
    ...
    \tikzstyle{place-time}=[circle,thick,draw=blue!75,fill=black!20,minimum size=6mm]
...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.3cm,>=stealth',bend angle=45,auto]
    % Styles are from https://texample.net/tikz/examples/nodetutorial/
    \tikzstyle{place-status}=[circle,thick,draw=red!75,fill=black!20,minimum size=6mm]
    \tikzstyle{transition}=[rectangle,thick,draw=black!75,
    fill=black!20,minimum size=4mm]
...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.3cm,>=stealth',bend angle=45,auto]
    % Styles are from https://texample.net/tikz/examples/nodetutorial/
    \tikzstyle{place-endpoint}=[circle,thick,draw=yellow!75,fill=black!20,minimum size=6mm]
    \tikzstyle{transition}=[rectangle,thick,draw=black!75,
    fill=black!20,minimum size=4mm]
...
The diagram also illustrates what the observable state of the application is: The marking of its state places.
...
\begin{figure}
  ...
  \begin{tikzpicture}[node distance=1.3cm,>=stealth',bend angle=45,auto]
    ...
    \tikzstyle{place-status}=[circle,thick,draw=red!75,fill=black!20,minimum size=6mm]
    \tikzstyle{place-time}=[circle,thick,draw=blue!75,fill=black!20,minimum size=6mm]
    \tikzstyle{place-app}=[circle,thick,draw=green!75,fill=black!20,minimum size=6mm]
  ...
  \end{tikzpicture}
\caption{Petri net for an \gls{app} (green) that waits for a transaction to be confirmed and then waits for slot number ten to begin, or for user input}
