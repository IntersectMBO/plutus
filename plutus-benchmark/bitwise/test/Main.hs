...
import PlutusTx.Test (goldenBudget, goldenBudgetAndSize, goldenEvalCekCatch, goldenPirReadable,
                      goldenSize)
...
main = defaultMain . testGroup "bitwise" $ [
  testGroup "N-queens" [
    ...
    runTestGhc [
      ...
      goldenBudgetAndSize "8 queens" $ nqueensCompiled `unsafeApplyCode` dimAsData,
