...
testClausify = testGroup "clausify"
               ...
               , runTestGhc
                     ...
                     , Tx.goldenBudgetAndSize "clausify-F5" formula5example
...
testKnights = testGroup "knights"  -- Odd sizes call "error" because there are no solutions
              ...
              , runTestGhc
                    ...
                    , Tx.goldenBudgetAndSize "knights10-4x4" knightsExample
...
testQueens = testGroup "queens"
             [ testGroup "4x4"
               ...
               , runTestGhc
                     ...
                     , Tx.goldenBudgetAndSize "queens4-bt" queens4btExample
             ...
             , testGroup "5x5"
               ...
               , runTestGhc
                     ...
                     , Tx.goldenBudgetAndSize "queens5-fc" queens5fcExample
