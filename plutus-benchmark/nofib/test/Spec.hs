...
testClausify = testGroup "clausify"
               ...
               , Tx.fitsInto "formula1 (size)" (Clausify.mkClausifyCode Clausify.F1) 3292
               , runTestNested $
...
testKnights = testGroup "knights"  -- Odd sizes call "error" because there are no solutions
              ...
              , Tx.fitsInto "depth 10, 4x4 (size)" (Knights.mkKnightsCode 10 4) 2512
...
testQueens = testGroup "queens"
             ...
             , Tx.fitsInto "Bt (size)" (Queens.mkQueensCode 5 Queens.Bt) 1919
             ]
