...
versionedTestGroup = runTestNested . testNestedGhc "nofib/test"
...
testClausify = testGroup "clausify"
               ...
               , versionedTestGroup [ Tx.goldenPirReadable "clausify-F5" formula5example
...
testKnights = testGroup "knights"  -- Odd sizes call "error" because there are no solutions
              ...
              , versionedTestGroup [ Tx.goldenPirReadable "knights10-4x4" knightsExample
...
testQueens = testGroup "queens"
             [ testGroup "4x4"
               ...
               , versionedTestGroup [ Tx.goldenPirReadable "queens4-bt" queens4btExample
             ...
             , testGroup "5x5"
               ...
               , versionedTestGroup [ Tx.goldenPirReadable "queens5-fc" queens5fcExample
