...
-- | Explicit MatchData-based Data.Constr matchers for the CPU runtime comparison.
...
matching_implementation = "matchdata"
...
matchDataMatcher :: (UPLC.Name -> PLC.Quote NamedTerm) -> Term
matchDataMatcher makeBody =
...
match_benchmark_constr_flat_d1_w1_c1_matchdata :: Term
match_benchmark_constr_flat_d1_w1_c1_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w16_c4_matchdata :: Term
match_benchmark_constr_flat_d1_w16_c4_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c1_matchdata :: Term
match_benchmark_constr_flat_d1_w1000_c1_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c16_matchdata :: Term
match_benchmark_constr_flat_d1_w1000_c16_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues =
          [ 7
          , 61
...
match_benchmark_constr_spine_front_d4_w16_c8_matchdata :: Term
match_benchmark_constr_spine_front_d4_w16_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_middle_d4_w16_c8_matchdata :: Term
match_benchmark_constr_spine_middle_d4_w16_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2]; c2 ~ Constr 2 [...,@c3];
--        c3 ~ Constr 3 [...,@c4]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_last_d4_w16_c8_matchdata :: Term
match_benchmark_constr_spine_last_d4_w16_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_irregular_d4_w16_c8_matchdata :: Term
match_benchmark_constr_spine_irregular_d4_w16_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
match_benchmark_constr_spine_irregular_d8_w8_c8_matchdata :: Term
match_benchmark_constr_spine_irregular_d8_w8_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_front_d64_w2_c8_matchdata :: Term
match_benchmark_constr_spine_front_d64_w2_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_zigzag_d100_w2_c10_matchdata :: Term
match_benchmark_constr_spine_zigzag_d100_w2_c10_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_stress_d10_w100_c20_matchdata :: Term
match_benchmark_constr_spine_stress_d10_w100_c20_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues =
          [ 17
          , 83
...
match_benchmark_constr_binary_d3_w16_c8_matchdata :: Term
match_benchmark_constr_binary_d3_w16_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
--        d[4,18,...,94,104] ~ I @ => 556.
match_benchmark_constr_ternary_d3_w8_c10_matchdata :: Term
match_benchmark_constr_ternary_d3_w8_c10_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_quaternary_d3_w8_c17_matchdata :: Term
match_benchmark_constr_quaternary_d3_w8_c17_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues =
          [ 2
          , 10
...
match_benchmark_constr_rootfork2_d6_w12_c8_matchdata :: Term
match_benchmark_constr_rootfork2_d6_w12_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork3_d5_w10_c9_matchdata :: Term
match_benchmark_constr_rootfork3_d5_w10_c9_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork4_d4_w8_c8_matchdata :: Term
match_benchmark_constr_rootfork4_d4_w8_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_binary_stress_d8_w8_c32_matchdata :: Term
match_benchmark_constr_binary_stress_d8_w8_c32_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues =
          [ 60
          , 116
...
match_benchmark_constr_alt_spine_d16_w8_c8_matchdata :: Term
match_benchmark_constr_alt_spine_d16_w8_c8_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_alt_rootfork3_d5_w10_c9_matchdata :: Term
match_benchmark_constr_alt_rootfork3_d5_w10_c9_matchdata =
  matchDataMatcher $ \argumentName -> do
...
match_benchmark_constr_alt_binary_d8_w8_c32_matchdata :: Term
match_benchmark_constr_alt_binary_d8_w8_c32_matchdata =
  matchDataMatcher $ \argumentName -> do
    let captureValues =
          [ 60
          , 116
