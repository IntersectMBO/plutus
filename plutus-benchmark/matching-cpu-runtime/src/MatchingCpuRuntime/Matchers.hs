...
-- | Explicit MatchDataConstr-based Data.Constr matchers for the CPU runtime comparison.
...
import PlutusCore.Default.MatchDataConstr (encodeMatchDataConstrTable, mkMatchDataConstrPattern)
import PlutusCore.MkPlc (mkConstant)
import UntypedPlutusCore qualified as UPLC

matching_implementation :: String
matching_implementation = "matchdataconstr"
...
matchDataConstrMatcher :: (UPLC.Name -> PLC.Quote NamedTerm) -> Term
matchDataConstrMatcher makeBody =
...
-- | MatchDataConstr returns only selected fields to the branch handler.
matchConstrNode
  :: Int
  -> Int
  -> [(Int, FieldMatcher)]
...
matchConstrNode width expectedTag fieldsToMatch scrutinee continuation = do
  ...
  unless
    ( all (\index -> 0 <= index && index < width) selectedIndices
  ...
  let handler = foldr (UPLC.LamAbs ()) fieldsBody fieldNames
      capturePattern =
        either (error . show) id $ mkMatchDataConstrPattern width selectedIndices
      encodedPatterns =
        either (error . show) id . encodeMatchDataConstrTable $
          Strict.singleton (toInteger expectedTag, capturePattern)
      matched =
        builtinApp
          1
          PLC.MatchDataConstr
          [ mkConstant @BS.ByteString () encodedPatterns
          , UPLC.Var () scrutinee
          ]
  pure $
    UPLC.Case
...
-- Sketch: matchDataConstr; case the resulting VConstr; unIData selected fields.

-- Match: Constr 1 [@d1]; d1 ~ I @ => 1.
match_benchmark_constr_flat_d1_w1_c1_matchdataconstr :: Term
match_benchmark_constr_flat_d1_w1_c1_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w16_c4_matchdataconstr :: Term
match_benchmark_constr_flat_d1_w16_c4_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c1_matchdataconstr :: Term
match_benchmark_constr_flat_d1_w1000_c1_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c16_matchdataconstr :: Term
match_benchmark_constr_flat_d1_w1000_c16_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues =
          [ 7
          , 61
...
match_benchmark_constr_spine_front_d4_w16_c8_matchdataconstr :: Term
match_benchmark_constr_spine_front_d4_w16_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_middle_d4_w16_c8_matchdataconstr :: Term
match_benchmark_constr_spine_middle_d4_w16_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2]; c2 ~ Constr 2 [...,@c3];
--        c3 ~ Constr 3 [...,@c4]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_last_d4_w16_c8_matchdataconstr :: Term
match_benchmark_constr_spine_last_d4_w16_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_irregular_d4_w16_c8_matchdataconstr :: Term
match_benchmark_constr_spine_irregular_d4_w16_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
match_benchmark_constr_spine_irregular_d8_w8_c8_matchdataconstr :: Term
match_benchmark_constr_spine_irregular_d8_w8_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_front_d64_w2_c8_matchdataconstr :: Term
match_benchmark_constr_spine_front_d64_w2_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_zigzag_d100_w2_c10_matchdataconstr :: Term
match_benchmark_constr_spine_zigzag_d100_w2_c10_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_stress_d10_w100_c20_matchdataconstr :: Term
match_benchmark_constr_spine_stress_d10_w100_c20_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues =
          [ 17
          , 83
...
match_benchmark_constr_binary_d3_w16_c8_matchdataconstr :: Term
match_benchmark_constr_binary_d3_w16_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
--        d[4,18,...,94,104] ~ I @ => 556.
match_benchmark_constr_ternary_d3_w8_c10_matchdataconstr :: Term
match_benchmark_constr_ternary_d3_w8_c10_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_quaternary_d3_w8_c17_matchdataconstr :: Term
match_benchmark_constr_quaternary_d3_w8_c17_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues =
          [ 2
          , 10
...
match_benchmark_constr_rootfork2_d6_w12_c8_matchdataconstr :: Term
match_benchmark_constr_rootfork2_d6_w12_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork3_d5_w10_c9_matchdataconstr :: Term
match_benchmark_constr_rootfork3_d5_w10_c9_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork4_d4_w8_c8_matchdataconstr :: Term
match_benchmark_constr_rootfork4_d4_w8_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_binary_stress_d8_w8_c32_matchdataconstr :: Term
match_benchmark_constr_binary_stress_d8_w8_c32_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues =
          [ 60
          , 116
...
match_benchmark_constr_alt_spine_d16_w8_c8_matchdataconstr :: Term
match_benchmark_constr_alt_spine_d16_w8_c8_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_alt_rootfork3_d5_w10_c9_matchdataconstr :: Term
match_benchmark_constr_alt_rootfork3_d5_w10_c9_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
...
match_benchmark_constr_alt_binary_d8_w8_c32_matchdataconstr :: Term
match_benchmark_constr_alt_binary_d8_w8_c32_matchdataconstr =
  matchDataConstrMatcher $ \argumentName -> do
    let captureValues =
          [ 60
          , 116
