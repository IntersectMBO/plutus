...
-- | Explicit shallow Data.Constr matchers for the CPU runtime comparison.
...
matching_implementation = "shallow"
...
shallowMatcher :: (UPLC.Name -> PLC.Quote NamedTerm) -> Term
shallowMatcher makeBody =
...
{-| Match one shallow Constr node. Each case still supplies its own tags,
immediate field operations, and recursive child continuations. -}
matchConstrNode
  :: Int
  -> [Word64]
  -> [(Int, FieldMatcher)]
  ...
  -> NamedTerm
  -> PLC.Quote NamedTerm
matchConstrNode width tags fieldsToMatch scrutinee continuation = do
  let orderedFields = sortOn fst fieldsToMatch
  fieldNames <- traverse (const $ freshName "field") orderedFields
  body <-
    foldrM
      (\((_, matchField), fieldName) next -> matchField fieldName next)
      continuation
      (zip orderedFields fieldNames)
  let boundFields = fmap fst orderedFields
      fields =
        Vector.generate width $ \fieldIndex ->
          if fieldIndex `elem` boundFields
            then DefaultPatternFieldBind
            else DefaultPatternFieldWildcard
      handler = foldr (UPLC.LamAbs ()) body fieldNames
      alternative tag =
        ( DefaultPatternDataConstr tag DefaultPatternFieldsExact fields
        , handler
        )
  pure $
    UPLC.Match
      ()
      (UPLC.Var () scrutinee)
      (Vector.fromList $ fmap alternative tags)

-- Sketch: _ = wildcard; @x = bound field; x ~ P = following Match; every Constr is exact.

-- Match: Constr 1 [@d1]; d1 ~ I @ => 1.
match_benchmark_constr_flat_d1_w1_c1_shallow :: Term
match_benchmark_constr_flat_d1_w1_c1_shallow =
...
match_benchmark_constr_flat_d1_w16_c4_shallow :: Term
match_benchmark_constr_flat_d1_w16_c4_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c1_shallow :: Term
match_benchmark_constr_flat_d1_w1000_c1_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_flat_d1_w1000_c16_shallow :: Term
match_benchmark_constr_flat_d1_w1000_c16_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues =
          [ 7
          , 61
...
match_benchmark_constr_spine_front_d4_w16_c8_shallow :: Term
match_benchmark_constr_spine_front_d4_w16_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_middle_d4_w16_c8_shallow :: Term
match_benchmark_constr_spine_middle_d4_w16_c8_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2]; c2 ~ Constr 2 [...,@c3];
--        c3 ~ Constr 3 [...,@c4]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_last_d4_w16_c8_shallow :: Term
match_benchmark_constr_spine_last_d4_w16_c8_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
-- Match: Constr 1 [...,@c2,...]; c2 ~ Constr 2 [...,@c3,...];
--        c3 ~ Constr 3 [...,@c4,...]; c4 ~ Constr 4 [...]; d[2,15,...,51,62] ~ I @ => 266.
match_benchmark_constr_spine_irregular_d4_w16_c8_shallow :: Term
match_benchmark_constr_spine_irregular_d4_w16_c8_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues = [2, 15, 21, 28, 40, 47, 51, 62] :: [Int]
...
match_benchmark_constr_spine_irregular_d8_w8_c8_shallow :: Term
match_benchmark_constr_spine_irregular_d8_w8_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_front_d64_w2_c8_shallow :: Term
match_benchmark_constr_spine_front_d64_w2_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_zigzag_d100_w2_c10_shallow :: Term
match_benchmark_constr_spine_zigzag_d100_w2_c10_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_spine_stress_d10_w100_c20_shallow :: Term
match_benchmark_constr_spine_stress_d10_w100_c20_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues =
          [ 17
          , 83
...
match_benchmark_constr_binary_d3_w16_c8_shallow :: Term
match_benchmark_constr_binary_d3_w16_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
--        d[4,18,...,94,104] ~ I @ => 556.
match_benchmark_constr_ternary_d3_w8_c10_shallow :: Term
match_benchmark_constr_ternary_d3_w8_c10_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_quaternary_d3_w8_c17_shallow :: Term
match_benchmark_constr_quaternary_d3_w8_c17_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues =
          [ 2
          , 10
...
match_benchmark_constr_rootfork2_d6_w12_c8_shallow :: Term
match_benchmark_constr_rootfork2_d6_w12_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork3_d5_w10_c9_shallow :: Term
match_benchmark_constr_rootfork3_d5_w10_c9_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_rootfork4_d4_w8_c8_shallow :: Term
match_benchmark_constr_rootfork4_d4_w8_c8_shallow =
  shallowMatcher $ \argumentName -> do
...
match_benchmark_constr_binary_stress_d8_w8_c32_shallow :: Term
match_benchmark_constr_binary_stress_d8_w8_c32_shallow =
  shallowMatcher $ \argumentName -> do
    let captureValues =
          [ 60
          , 116
