...
testCostModel =
  ...
  , ("sha2_512-cpu-arguments-intercept", 806990)
  , ("sha2_512-cpu-arguments-slope", 30482)
  , ("sha2_512-memory-arguments", 4)
  , ("sha3_512-cpu-arguments-intercept", 1927926)
  , ("sha3_512-cpu-arguments-slope", 82523)
  , ("sha3_512-memory-arguments", 4)
