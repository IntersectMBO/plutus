...
import PlutusLedgerApi.Data.V2 (CurrencySymbol, ScriptContext, ScriptHash (..), SerialisedScript,
                                TokenName, scriptContextTxInfo, serialiseCompiledCode)
import PlutusLedgerApi.V2.Data.Contexts (valueSpent)
