...
-->
 ...
 <br/>
 Total number of iterations: <span class="iters{{number}}">xxx</span>
 <br/>
 Total time: <span class="times{{number}}">xxx</span> 
 <br/>
 <br/>
...
$(function () {
  function mangulate(rpt) {
    ...
    $(".iters" + number).text(function() {
        return iters.reduce ((a,b) => a+b, 0);
      });
    var times = measured("time");
    $(".times" + number).text(function() {
        var tot = times.reduce ((a,b) => a+b, 0);
        return $.renderTime(tot);
      });
