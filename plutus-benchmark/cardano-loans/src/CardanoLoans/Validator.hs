...
{-# OPTIONS_GHC -fplugin-opt PlutusTx.Plugin:optimization-bias=4 #-}
...
data LoanDatum
  ...
  | -- | The datum for the offer phase.
    OfferDatum
      ...
      , loanBacking :: Integer
      {-^ How much of the loan needs to be collateralized. In units of the
      loanAsset. -}
      , collateralRates :: [((CurrencySymbol, TokenName), Rational)]
      -- ^ Rates: collateralAsset/loanAsset
      }
...
{-# INLINEABLE stakingCredApproves #-}
