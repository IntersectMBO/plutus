...
makeBenchmarks evalCtx _gen =
  [ benchOneTextString      evalCtx EncodeUtf8
  , benchOneUtf8ByteString  evalCtx DecodeUtf8
  , benchTwoTextStrings     evalCtx AppendString
  , benchSameTwoTextStrings evalCtx EqualsString
  ]
