...
-}
benchExpModInteger :: EvaluationContext -> StdGen -> Benchmark
benchExpModInteger evalCtx _gen =
...
makeBenchmarks evalCtx gen =
  [ benchTwoIntegers evalCtx gen makeLargeIntegerArgs AddInteger -- SubtractInteger behaves identically.
  , benchTwoIntegers evalCtx gen makeDefaultIntegerArgs MultiplyInteger
  , benchTwoIntegers evalCtx gen makeDefaultIntegerArgs DivideInteger
           -- ^ RemainderInteger, QuotientInteger, and ModInteger all behave identically.
  , benchSameTwoIntegers evalCtx gen EqualsInteger
  , benchSameTwoIntegers evalCtx gen LessThanInteger
  , benchSameTwoIntegers evalCtx gen LessThanEqualsInteger
  , benchExpModInteger evalCtx gen
  ]
