...
The documentation for the metatheory can be found https://intersectmbo.github.io/plutus/metatheory/latsest[here].
...
- https://intersectmbo.github.io/plutus/resources/system-f-in-agda-psaper.pdf[System F in Agda]: a formal model of System F in Agda (https://doi.org/10.1007/978-3-030-33636-3_10[published version]).
