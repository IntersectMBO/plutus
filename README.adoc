...
- https://hydra.iohk.io/job/Cardano/plutus/papers.system-f-in-agda.x86_64-linux/latest/download-by-type/doc-pdf/paper[System F in Agda] - https://link.springer.com/chapter/10.1007/978-3-030-33636-3_10#citeas[published version]
