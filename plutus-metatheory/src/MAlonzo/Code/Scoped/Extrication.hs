  ...
  = case coe v2 of
      ...
      MAlonzo.Code.Type.BetaNormal.C__'8658'__16 v4 v5
        -> coe
             ...
             (coe
                d_extricateNf'8902'_26 (coe v0) (coe MAlonzo.Code.Utils.C_'42'_756)
                (coe v4))
             (coe
                d_extricateNf'8902'_26 (coe v0) (coe MAlonzo.Code.Utils.C_'42'_756)
                (coe v5))
        ...
        -> case coe v4 of
             MAlonzo.Code.Type.BetaNormal.C_ne_20 v7
               -> coe
                    ...
                    (coe MAlonzo.Code.Utils.C_'9839'_758) (coe v7)
             _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v2 of
      ...
      MAlonzo.Code.Type.BetaNormal.C__'183'__10 v4 v6 v7
        -> coe
             ...
             (coe
                d_extricateNe'8902'_34 (coe v0)
                (coe MAlonzo.Code.Utils.C__'8658'__760 (coe v4) (coe v1)) (coe v6))
