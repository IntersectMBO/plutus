...
d_divModFixup_38 v0 v1 v2 ~v3 = du_divModFixup_38 v0 v1 v2
du_divModFixup_38 ::
  Integer ->
  Integer -> Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_divModFixup_38 v0 v1 v2
  = let v3
          = coe
...
d_divMod_64 ::
  ...
  MAlonzo.Code.Data.Nat.Base.T_NonZero_112 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_divMod_64 v0 v1 ~v2 = du_divMod_64 v0 v1
du_divMod_64 ::
  Integer -> Integer -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_divMod_64 v0 v1
  = coe
      du_divModFixup_38 (coe du_quot_12 (coe v0) (coe v1))
      (coe du_rem_24 (coe v0) (coe v1)) (coe v1)
-- Builtin.Integer.Base.div
d_div_76 ::
  Integer ->
  Integer -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112 -> Integer
d_div_76 v0 v1 ~v2 = du_div_76 v0 v1
du_div_76 :: Integer -> Integer -> Integer
du_div_76 v0 v1
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_fst_28
      (coe du_divMod_64 (coe v0) (coe v1))
-- Builtin.Integer.Base.mod
d_mod_88 ::
  Integer ->
  Integer -> MAlonzo.Code.Data.Nat.Base.T_NonZero_112 -> Integer
d_mod_88 v0 v1 ~v2 = du_mod_88 v0 v1
...
agdaQuotientInteger = coe d_quotMaybe_94
d_quotMaybe_94 :: Integer -> Integer -> Maybe Integer
d_quotMaybe_94 v0 v1
  = let v2
...
agdaRemainderInteger ::
  Integer ->
  Integer -> MAlonzo.Code.Agda.Builtin.Maybe.T_Maybe_10 () Integer
agdaRemainderInteger = coe d_remMaybe_120
d_remMaybe_120 :: Integer -> Integer -> Maybe Integer
d_remMaybe_120 v0 v1
  = let v2
          = MAlonzo.Code.Data.Integer.Properties.d__'8799'__2800
              (coe v1) (coe MAlonzo.Code.Data.Integer.Base.d_0ℤ_12) in
    coe
