...
d_isFloatDelay'63'_488 v0
  = coe
      ...
      (coe v0)
      (coe MAlonzo.Code.VerifiedCompilation.Trace.d_floatDelayTag_26)
      (coe d_isFlD'63'_492)
         ...
         MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v4 v5
           -> if coe v4
                then case coe v5 of
                                                                                                                                                                 ...
                                                                                                                                                                 -> if coe
                                                                                                                                                                      ...
                                                                                                                                                                      then case coe
                                                                                                                                                                             ...
                                                                                                                                                                             (coe
                                                                                                                                                                                ...
                                                                                                                                                                                MAlonzo.Code.VerifiedCompilation.Trace.d_floatDelayTag_26
                                                                                                                                                                                v1
                                                                                                                                                                                v2)
                                                                                                                                                               _ -> MAlonzo.RTE.mazUnreachableError)
                       ...
                       (coe
                          MAlonzo.Code.VerifiedCompilation.Certificate.C_ce_52
                          MAlonzo.Code.VerifiedCompilation.Trace.d_floatDelayTag_26 v1 v2)
         _ -> MAlonzo.RTE.mazUnreachableError)
