...
d_isLambda'63'_70 ::
  ...
  MAlonzo.Code.Untyped.T__'8866'_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_isLambda'63'_70 ~v0 ~v1 v2 v3 = du_isLambda'63'_70 v2 v3
du_isLambda'63'_70 ::
  (() ->
   MAlonzo.Code.Untyped.T__'8866'_14 ->
   MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20) ->
...
d_isTestPat'63'_818 ::
  ...
  MAlonzo.Code.Untyped.T__'8866'_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_isTestPat'63'_818 ~v0 v1 = du_isTestPat'63'_818 v1
du_isTestPat'63'_818 ::
  MAlonzo.Code.Untyped.T__'8866'_14 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_isTestPat'63'_818 v0
  = let v1
          = coe
              du_isCase'63'_598 erased
              (coe
                 (\ v1 ->
                    coe
                      du_isCase'63'_598 erased (\ v2 v3 -> coe du_isTerm'63'_782)
                      (\ v2 v3 -> coe du_allTerms'63'_798)))
              (\ v1 v2 -> coe du_allTerms'63'_798) (coe v0) in
    coe
      (case coe v1 of
