...
d_a2c'63''7580''7580'_24 v0
  = coe
      ...
      (coe v0)
      (coe MAlonzo.Code.VerifiedCompilation.Trace.d_applyToCaseTag_40)
      (coe d_a2c'63'_32)
         ...
         (case coe v2 of
            MAlonzo.Code.Untyped.C_'96'_18 v5
              -> coe
                   ...
                   MAlonzo.Code.VerifiedCompilation.Trace.d_applyToCaseTag_40 v1 v2
                                        ...
                                        MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v11 v12
                                          -> if coe v11
                                               then case coe v12 of
                                                      ...
                                                      (coe
                                                         MAlonzo.Code.VerifiedCompilation.Certificate.C_ce_52
                                                         MAlonzo.Code.VerifiedCompilation.Trace.d_applyToCaseTag_40
                                                         v1 v2)
                                        _ -> MAlonzo.RTE.mazUnreachableError))
                      _ -> MAlonzo.RTE.mazUnreachableError)
