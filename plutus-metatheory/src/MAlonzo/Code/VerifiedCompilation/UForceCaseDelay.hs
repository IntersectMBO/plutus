...
d_isForceCaseDelay'63'_94 v0
  = coe
      ...
      (coe v0)
      (coe MAlonzo.Code.VerifiedCompilation.Trace.d_forceCaseDelayTag_30)
      (coe d_isFCD'63'_96)
         ...
         MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v4 v5
           -> if coe v4
                then case coe v5 of
                                                                                                                                       ...
                                                                                                                                       MAlonzo.Code.VerifiedCompilation.Certificate.C_proof_44 v31
                                                                                                                                         -> let v32
                                                                                                                                                  = coe
                                                                                                                                                      ...
                                                                                                                                                      (coe
                                                                                                                                                         MAlonzo.Code.VerifiedCompilation.Trace.d_forceCaseDelayTag_30)
                                                                                                                                                      (coe
                                                                                                                                                         d_isForceCaseDelay'63'_94
                                                                                                                                                         (coe
                                                                                                                                                            v0))
                       ...
                       (coe
                          MAlonzo.Code.VerifiedCompilation.Certificate.C_ce_52
                          MAlonzo.Code.VerifiedCompilation.Trace.d_forceCaseDelayTag_30 v1
                          v2)
         _ -> MAlonzo.RTE.mazUnreachableError)
