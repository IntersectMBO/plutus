...
pattern C_'42'_660 = Star
pattern C_'9839'_662 = Sharp
pattern C__'8658'__664 a0 a1 = Arrow a0 a1
check_'42'_660 :: T_Kind_658
check_'42'_660 = Star
check_'9839'_662 :: T_Kind_658
check_'9839'_662 = Sharp
check__'8658'__664 :: T_Kind_658 -> T_Kind_658 -> T_Kind_658
check__'8658'__664 = Arrow
cover_Kind_658 :: KIND -> ()
cover_Kind_658 x
  = case x of
      Star -> ()
