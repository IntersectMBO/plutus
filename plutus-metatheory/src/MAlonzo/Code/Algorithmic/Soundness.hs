               ...
               -> case coe v1 of
                    MAlonzo.Code.Algorithmic.C__'44''8902'__8 v11
                      -> coe
                           ...
                           (MAlonzo.Code.Type.BetaNormal.d_embNf_128
                              (coe v8) (coe MAlonzo.Code.Utils.C_'42'_908) (coe v6))
...
d_emb'91''93'_38 v0 v1 v2 v3
  = coe
      ...
      (MAlonzo.Code.Type.BetaNormal.d_embNf_128
         (coe v0) (coe MAlonzo.Code.Utils.C_'42'_908)
         (coe
            ...
            (coe
               ...
               (coe v1) (coe MAlonzo.Code.Utils.C_'42'_908)
               (coe
                  MAlonzo.Code.Type.BetaNormal.d_embNf_128
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Utils.C__'8658'__912 (coe v1)
                     (coe MAlonzo.Code.Utils.C_'42'_908))
                  (MAlonzo.Code.Type.BetaNormal.d_embNf_128
                     (coe v0)
                     (coe
      ...
      (MAlonzo.Code.Type.BetaNormal.d_embNf_128
         ...
         (coe
            ...
            (coe
               ...
               (coe MAlonzo.Code.Utils.C_'9839'_910) (coe v3))
            (coe MAlonzo.Code.Type.BetaNBE.du_idEnv_250)))
      (coe
         MAlonzo.Code.Type.Equality.C_trans'8801'β_18
         (MAlonzo.Code.Type.BetaNormal.d_embNf_128
            ...
            (coe
               ...
               (coe
                  MAlonzo.Code.Type.BetaNormal.d_embNf_128 (coe v1)
                  (coe MAlonzo.Code.Utils.C_'9839'_910) (coe v2))
               (coe
                  (\ v5 v6 ->
                     MAlonzo.Code.Type.BetaNBE.d_eval_166
  ...
  = coe
      ...
      (MAlonzo.Code.Type.RenamingSubstitution.d_sub_346
         ...
         (coe
            ...
            (coe MAlonzo.Code.Utils.C_'9839'_910) (coe v1)))
      (coe
      ...
      MAlonzo.Code.Algorithmic.C__'183''8902'_'47'__218 v4 v6 v7 v8
        -> coe
             ...
             (MAlonzo.Code.Type.RenamingSubstitution.d__'91'_'93'_432
                (coe v0) (coe v4) (coe MAlonzo.Code.Utils.C_'42'_908)
                (coe
                   MAlonzo.Code.Type.BetaNormal.d_embNf_128
