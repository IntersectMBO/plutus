...
import MAlonzo.Code.Type.BetaNBE.Soundness qualified
      ...
      MAlonzo.Code.Declarative.C__'44'__26 v3 v4
        -> coe
             ...
             (MAlonzo.Code.Type.BetaNBE.d_nf_258
                (coe v0) (coe MAlonzo.Code.Utils.C_'42'_638) (coe v4))
      _ -> MAlonzo.RTE.mazUnreachableError
                    ...
                    MAlonzo.Code.Declarative.C__'44''8902'__22 v11
                      -> coe
                           ...
                           (MAlonzo.Code.Type.BetaNBE.d_eval_166
                              (coe v8) (coe v8) (coe MAlonzo.Code.Utils.C_'42'_638) (coe v5)
...
d_mkTy'45'lem_172 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_mkTy'45'lem_172 = erased
-- Algorithmic.Completeness.sig2type⇒-lem
d_sig2type'8658''45'lem_188 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Type.BetaNormal.T__'8866'Nf'8902'__4 ->
  MAlonzo.Code.Type.T__'8866''8902'__20 ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sig2type'8658''45'lem_188 = erased
-- Algorithmic.Completeness.sig2typeΠ-lem
d_sig2typeΠ'45'lem_206 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Type.T__'8866''8902'__20 ->
  MAlonzo.Code.Type.BetaNormal.T__'8866'Nf'8902'__4 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sig2typeΠ'45'lem_206 = erased
-- Algorithmic.Completeness.sig2type-lem
d_sig2type'45'lem_222 ::
  MAlonzo.Code.Builtin.Signature.T_Sig_68 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_sig2type'45'lem_222 = erased
-- Algorithmic.Completeness.btype-lem
d_btype'45'lem_250 ::
  MAlonzo.Code.Type.T_Ctx'8902'_2 ->
  MAlonzo.Code.Builtin.T_Builtin_2 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_btype'45'lem_250 = erased
...
d_nfType_260 v0 v1 v2 v3
  = case coe v3 of
      ...
      MAlonzo.Code.Declarative.C__'183'__118 v4 v6 v7
        -> coe
             ...
             (MAlonzo.Code.Type.BetaNBE.d_reify_86
                (coe MAlonzo.Code.Utils.C_'42'_638) (coe v0)
                (coe
                   MAlonzo.Code.Type.BetaNBE.d_eval_166 (coe v0) (coe v0)
                   (coe MAlonzo.Code.Utils.C_'42'_638) (coe v4)
                   (coe MAlonzo.Code.Type.BetaNBE.du_idEnv_250)))
             (d_nfType_260
                (coe v0) (coe v1) (coe MAlonzo.Code.Type.C__'8658'__26 v4 v2)
                (coe v6))
             (d_nfType_260 (coe v0) (coe v1) (coe v4) (coe v7))
      ...
      MAlonzo.Code.Declarative.C__'183''8902'__124 v4 v5 v6 v7
        -> coe
             MAlonzo.Code.Algorithmic.C__'183''8902'_'47'__202 v4
             (MAlonzo.Code.Type.BetaNBE.d_nf_258
                (coe MAlonzo.Code.Type.C__'44''8902'__6 (coe v0) (coe v4))
                (coe MAlonzo.Code.Utils.C_'42'_638) (coe v5))
             (d_nfType_260
                    ...
                    (d_nfType_260
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Utils.C__'8658'__642 (coe v9)
             ...
             MAlonzo.Code.Type.C__'183'__30 v9 v11 v12
               -> case coe v11 of
                    MAlonzo.Code.Type.C__'183'__30 v14 v16 v17
                      -> coe
                           MAlonzo.Code.Algorithmic.C_unwrap_220 v9
                           (MAlonzo.Code.Type.BetaNBE.d_reify_86
                              (coe
                                 MAlonzo.Code.Utils.C__'8658'__642
                                 (coe
      ...
      MAlonzo.Code.Declarative.C_constr_142 v5 v7 v9
        -> case coe v2 of
             MAlonzo.Code.Type.C_SOP_40 v11 v12
               -> coe
                    MAlonzo.Code.Algorithmic.C_constr_230 v5
                    (MAlonzo.Code.Type.BetaNBE.d_eval'45'List_174
                       (coe v0) (coe v0) (coe MAlonzo.Code.Utils.C_'42'_638)
                       (coe MAlonzo.Code.Data.Vec.Base.du_lookup_82 (coe v12) (coe v5))
                       (coe MAlonzo.Code.Type.BetaNBE.du_idEnv_250))
                    (d_nfType'45'ConstrArgs_270
                       (coe v0) (coe v1)
                       (coe MAlonzo.Code.Data.Vec.Base.du_lookup_82 (coe v12) (coe v5))
                       (coe v9))
             _ -> MAlonzo.RTE.mazUnreachableError
      MAlonzo.Code.Declarative.C_case_154 v4 v5 v7 v8
        -> coe
             MAlonzo.Code.Algorithmic.C_case_242 v4
             (coe
...
d_nfType'45'ConstrArgs_270 ::
  ...
  MAlonzo.Code.Utils.List.T_IList_302
d_nfType'45'ConstrArgs_270 v0 v1 v2 v3
  = case coe v3 of
        ...
        -> case coe v2 of
             (:) v8 v9
               -> coe
                    ...
                    (d_nfType_260 (coe v0) (coe v1) (coe v8) (coe v6))
                    (d_nfType'45'ConstrArgs_270 (coe v0) (coe v1) (coe v9) (coe v7))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algorithmic.Completeness.lemma-mkCaseType
d_lemma'45'mkCaseType_282 ::
  MAlonzo.Code.Type.T_Ctx'8902'_2 ->
  MAlonzo.Code.Type.T__'8866''8902'__20 ->
  [MAlonzo.Code.Type.T__'8866''8902'__20] ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_lemma'45'mkCaseType_282 = erased
-- Algorithmic.Completeness.nfType-Cases
d_nfType'45'Cases_302 ::
  MAlonzo.Code.Type.T_Ctx'8902'_2 ->
  MAlonzo.Code.Declarative.T_Ctx_16 ->
  MAlonzo.Code.Type.T__'8866''8902'__20 ->
  Integer ->
...
d_nfType'45'Cases_302 v0 v1 v2 ~v3 v4 v5
  = du_nfType'45'Cases_302 v0 v1 v2 v4 v5
du_nfType'45'Cases_302 ::
  MAlonzo.Code.Type.T_Ctx'8902'_2 ->
  MAlonzo.Code.Declarative.T_Ctx_16 ->
  MAlonzo.Code.Type.T__'8866''8902'__20 ->
  MAlonzo.Code.Data.Vec.Base.T_Vec_28 ->
  MAlonzo.Code.Declarative.T_Cases_104 ->
  MAlonzo.Code.Algorithmic.T_Cases_162
du_nfType'45'Cases_302 v0 v1 v2 v3 v4
  = case coe v4 of
             ...
             MAlonzo.Code.Data.Vec.Base.C__'8759'__38 v11 v12
               -> coe
                    ...
                    (d_nfType_260
                       ...
                       (coe v8))
                    (coe
                       du_nfType'45'Cases_302 (coe v0) (coe v1) (coe v2) (coe v12)
                       (coe v9))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_completenessT_372 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32
      (coe d_nfType_260 (coe v0) (coe v1) (coe v2) (coe v3))
      (coe
