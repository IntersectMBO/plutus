...
d_sig2typeΠ_14
  = coe
      MAlonzo.Code.Builtin.Signature.du_sig2typeΠ_230
      (\ v0 v1 v2 -> coe MAlonzo.Code.Type.BetaNormal.C_Π_14 v1 v2)
-- Algorithmic.Signature._.sig2type⇒
d_sig2type'8658'_16 ::
  Integer ->
...
d_sig2type'8658'_16
  = coe
      MAlonzo.Code.Builtin.Signature.du_sig2type'8658'_216
      (\ v0 v1 v2 -> coe MAlonzo.Code.Type.BetaNormal.C_ne_20 v2)
      (coe
         (\ v0 v1 v2 v3 -> coe MAlonzo.Code.Type.BetaNormal.C_'96'_8 v3))
      (\ v0 v1 v2 v3 v4 ->
...
d_btype_30 v0 v1
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Builtin.d_signature_296 (coe v1)))
...
du_subSigTy_108 v0 v1 v2 v3
  = case coe v3 of
      MAlonzo.Code.Builtin.Signature.C_bresult_282
        -> coe MAlonzo.Code.Builtin.Signature.C_bresult_282
      MAlonzo.Code.Builtin.Signature.C__B'8658'__304 v12 v13 v14
        -> coe
             MAlonzo.Code.Builtin.Signature.C__B'8658'__304
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         ...
                         (coe MAlonzo.Code.Utils.C_'42'_660) (coe v13)))
                   (coe MAlonzo.Code.Type.BetaNBE.du_idEnv_250)))
             (coe du_subSigTy_108 (coe v0) (coe v1) (coe v2) (coe v14))
      MAlonzo.Code.Builtin.Signature.C_sucΠ_328 v13 v14 v15
        -> coe
             MAlonzo.Code.Builtin.Signature.C_sucΠ_328 v13
             (MAlonzo.Code.Type.BetaNBE.d_eval_166
                ...
                (coe
                   ...
                   (coe
                      MAlonzo.Code.Type.BetaNormal.d_embNf_128
                      (coe MAlonzo.Code.Type.C__'44''8902'__6 (coe v0) (coe v13))
                      (coe MAlonzo.Code.Utils.C_'42'_660) (coe v14)))
                (coe
                   (\ v16 v17 ->
                      coe
