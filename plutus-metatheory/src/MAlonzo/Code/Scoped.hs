...
data T_ScopedTy_14
  = C_'96'_18 MAlonzo.Code.Data.Fin.Base.T_Fin_10 |
    ...
    C_Π_22 MAlonzo.Code.Utils.T_Kind_832 T_ScopedTy_14 |
    C_ƛ_24 MAlonzo.Code.Utils.T_Kind_832 T_ScopedTy_14 |
    C__'183'__26 T_ScopedTy_14 T_ScopedTy_14 |
    C_con_30 MAlonzo.Code.Utils.T_Kind_832
             MAlonzo.Code.Builtin.Constant.Type.T_TyCon_6 |
    C_μ_32 T_ScopedTy_14 T_ScopedTy_14 |
    C_SOP_34 (MAlonzo.Code.Utils.T_List_454
                (MAlonzo.Code.Utils.T_List_454 T_ScopedTy_14))
-- Scoped.Tel⋆
...
d_shifterTyList_200 ::
  Integer ->
  T_Weirdℕ_42 ->
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTy_2 ->
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTy_2
d_shifterTyList_200 v0 v1 v2
  = case coe v2 of
      MAlonzo.Code.Utils.C_'91''93'_458 -> coe v2
...
d_shifterList_278 ::
  Integer ->
  T_Weirdℕ_42 ->
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTm_32 ->
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTm_32
...
data T_ScopedTm_522
  = C_'96'_528 T_WeirdFin_56 |
    C_Λ_530 MAlonzo.Code.Utils.T_Kind_832 T_ScopedTm_522 |
    ...
    C_constr_556 T_ScopedTy_14 Integer
                 (MAlonzo.Code.Utils.T_List_454 T_ScopedTm_522) |
        ...
        -> case coe v2 of
             MAlonzo.Code.Raw.C_atomic_24 v3
               -> coe
                    MAlonzo.Code.Utils.C_inj'8322'_14
                    (coe
                       C_con_30 (coe MAlonzo.Code.Utils.C_'9839'_836)
               ...
               -> coe
                    ...
                    (coe
                       ...
                       (coe
                          ...
                          (coe MAlonzo.Code.Utils.C_'9839'_836)
                          (coe MAlonzo.Code.Utils.C_'9839'_836))
...
d_scopeCheckTyList_620 ::
  ...
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTy_2 ->
  MAlonzo.Code.Utils.T_Either_6
    T_ScopeError_576 (MAlonzo.Code.Utils.T_List_454 T_ScopedTy_14)
                   ...
                   coe
                     ...
                     (coe
                        (\ v5 ->
                           coe
                             MAlonzo.Code.Utils.C_inj'8322'_14
                             (coe MAlonzo.Code.Utils.C__'8759'__460 (coe v4) (coe v5))))))
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_scopeCheckTmList_692 ::
  ...
  MAlonzo.Code.Utils.T_List_454 MAlonzo.Code.Raw.T_RawTm_32 ->
  MAlonzo.Code.Utils.T_Either_6
    T_ScopeError_576 (MAlonzo.Code.Utils.T_List_454 T_ScopedTm_522)
                   ...
                   coe
                     ...
                     (coe
                        (\ v6 ->
                           coe
                             MAlonzo.Code.Utils.C_inj'8322'_14
                             (coe MAlonzo.Code.Utils.C__'8759'__460 (coe v5) (coe v6))))))
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_extricateScopeTyList_784 v0 v1
  = case coe v1 of
      MAlonzo.Code.Utils.C_'91''93'_458 -> coe v1
      MAlonzo.Code.Utils.C__'8759'__460 v2 v3
        -> coe
             MAlonzo.Code.Utils.C__'8759'__460
             (coe d_extricateScopeTy_780 (coe v0) (coe v2))
