...
d_arity_304 v0
  = coe
      ...
      (coe
         ...
         (coe d_signature_298 (coe v0)))
-- Builtin.lengthBS
d_lengthBS_308 :: MAlonzo.Code.Utils.T_ByteString_418 -> Integer
d_lengthBS_308 = toInteger . BS.length
-- Builtin.index
d_index_310 ::
  MAlonzo.Code.Utils.T_ByteString_418 -> Integer -> Integer
...
-- Builtin.concat
d_concat_324 ::
  MAlonzo.Code.Utils.T_ByteString_418 ->
  MAlonzo.Code.Utils.T_ByteString_418 ->
  MAlonzo.Code.Utils.T_ByteString_418
...
d_B'60'_330 ::
  MAlonzo.Code.Utils.T_ByteString_418 ->
  MAlonzo.Code.Utils.T_ByteString_418 -> Bool
d_B'60'_330 = (<)
-- Builtin.B<=
d_B'60''61'_332 ::
  MAlonzo.Code.Utils.T_ByteString_418 ->
...
d_BLS12'45'381'45'G1'45'add_354 ::
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_756 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_756 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_756
...
d_BLS12'45'381'45'G1'45'equal_360 ::
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_756 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_756 -> Bool
d_BLS12'45'381'45'G1'45'equal_360 = (==)
...
d_BLS12'45'381'45'G2'45'add_368 ::
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_760 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_760 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_760
...
d_BLS12'45'381'45'G2'45'equal_374 ::
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_760 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_760 -> Bool
d_BLS12'45'381'45'G2'45'equal_374 = (==)
...
d_BLS12'45'381'45'finalVerify_386 ::
  MAlonzo.Code.Utils.T_Bls12'45'381'45'MlResult_764 ->
  MAlonzo.Code.Utils.T_Bls12'45'381'45'MlResult_764 -> Bool
...
-- Builtin.BStoI
d_BStoI_392 ::
  Bool -> MAlonzo.Code.Utils.T_ByteString_418 -> Integer
...
d_shiftBYTESTRING_410 ::
  MAlonzo.Code.Utils.T_ByteString_418 ->
  Integer -> MAlonzo.Code.Utils.T_ByteString_418
...
d_countSetBITS_414 ::
  MAlonzo.Code.Utils.T_ByteString_418 -> Integer
