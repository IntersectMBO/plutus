         ...
         (\ v1 ->
            let v2
                  = coe
                      ...
                      (coe
                         MAlonzo.Code.Evaluator.Base.C_runtimeError_20
                         (coe MAlonzo.Code.Utils.C_gasError_398)) in
            coe
              (case coe v1 of
                 ...
                 MAlonzo.Code.Untyped.CEK.C_'9670'_228
                   -> coe
                        ...
                        (coe
                           MAlonzo.Code.Evaluator.Base.C_runtimeError_20
                           (coe MAlonzo.Code.Utils.C_userError_400))
                 _ -> coe v2)))
-- Evaluator.Term.runU
runUAgda ::
  T_TermU_24 ->
...
runUCountingAgda ::
  ...
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Evaluator.Base.T_ERROR_12
    (MAlonzo.Code.Utils.T__'215'__414
       T_TermU_24 (MAlonzo.Code.Utils.T__'215'__414 Integer Integer))
                                  ...
                                  (coe
                                     ...
                                     (coe
                                        ...
                                        (coe
                                           ...
                                           (coe MAlonzo.Code.Utils.C__'44'__428 (coe v2) (coe v5)))
                                        (coe MAlonzo.Code.Evaluator.Base.d_maxsteps_72)
                                        (coe
