...
check_pdata_40 :: T_Tag_28 (T_Esc_24 MAlonzo.Code.Utils.T_DATA_698)
check_pdata_40 = TagData
check_value_42 ::
  T_Tag_28 (T_Esc_24 MAlonzo.Code.Utils.T_Value_870)
...
check_pair_48 ::
  forall xA.
    forall xB.
      ...
      T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T__'215'__508 xA xB))
check_pair_48 = TagPair
check_list_52 ::
  forall xA.
    T_Tag_28 (T_Esc_24 xA) ->
    T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T_List_526 xA))
check_list_52 = TagList
check_array_56 ::
  forall xA.
    T_Tag_28 (T_Esc_24 xA) ->
    T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T_Array_674 xA))
check_array_56 = TagArray
check_bls12'45'381'45'g1'45'element_58 ::
  T_Tag_28
    (T_Esc_24 MAlonzo.Code.Utils.T_Bls12'45'381'45'G1'45'Element_828)
check_bls12'45'381'45'g1'45'element_58 = TagBLS12_381_G1_Element
check_bls12'45'381'45'g2'45'element_60 ::
  T_Tag_28
    (T_Esc_24 MAlonzo.Code.Utils.T_Bls12'45'381'45'G2'45'Element_842)
check_bls12'45'381'45'g2'45'element_60 = TagBLS12_381_G2_Element
check_bls12'45'381'45'mlresult_62 ::
  T_Tag_28
    (T_Esc_24 MAlonzo.Code.Utils.T_Bls12'45'381'45'MlResult_856)
    ...
    coe
      (case coe v0 of
         ...
         C_bytestring_32
           -> case coe v2 of
                C_bytestring_32
                  -> coe MAlonzo.Code.Builtin.d_equals_436 (coe v1) (coe v3)
                _ -> coe v4
         C_string_34
           -> case coe v2 of
                C_string_34
         ...
         C_pdata_40
           -> case coe v2 of
                C_pdata_40 -> coe MAlonzo.Code.Utils.d_eqDATA_822 (coe v1) (coe v3)
                _ -> coe v4
         C_pair_48 v7 v8
           -> case coe v1 of
                MAlonzo.Code.Utils.C__'44'__522 v9 v10
                  -> case coe v2 of
                       C_pair_48 v13 v14
                         -> case coe v3 of
                              MAlonzo.Code.Utils.C__'44'__522 v15 v16
                                -> coe
           ...
           -> case coe v1 of
                ...
                MAlonzo.Code.Utils.C__'8759'__532 v7 v8
                  -> case coe v2 of
                       C_list_52 v10
                         -> case coe v3 of
                              MAlonzo.Code.Utils.C__'8759'__532 v11 v12
                                -> coe
                                     MAlonzo.Code.Data.Bool.Base.d__'8743'__24
...
check_UConstr_228 ::
  Integer ->
  MAlonzo.Code.Utils.T_List_526 T_Untyped_210 -> T_Untyped_210
