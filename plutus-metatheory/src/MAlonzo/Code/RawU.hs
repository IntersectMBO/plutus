...
check_pair_48 ::
  forall xA.
    forall xB.
      ...
      T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T__'215'__436 xA xB))
check_pair_48 = TagPair
check_list_52 ::
  forall xA.
    T_Tag_28 (T_Esc_24 xA) ->
    T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T_List_454 xA))
check_list_52 = TagList
check_array_56 ::
  forall xA.
    T_Tag_28 (T_Esc_24 xA) ->
    T_Tag_28 (T_Esc_24 (MAlonzo.Code.Utils.T_Array_602 xA))
  ...
  = let v4 = coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8 in
    coe
      (case coe v0 of
         ...
         C_bytestring_32
           -> case coe v2 of
                C_bytestring_32 -> coe MAlonzo.Code.Builtin.d_equals_360 v1 v3
                _ -> coe v4
         C_string_34
           -> case coe v2 of
                C_string_34
           ...
           -> case coe v1 of
                MAlonzo.Code.Utils.C__'44'__450 v9 v10
                  -> case coe v2 of
                       C_pair_48 v13 v14
                         -> case coe v3 of
                              MAlonzo.Code.Utils.C__'44'__450 v15 v16
                                -> coe
...
check_UConstr_228 ::
  Integer ->
  MAlonzo.Code.Utils.T_List_454 T_Untyped_210 -> T_Untyped_210
