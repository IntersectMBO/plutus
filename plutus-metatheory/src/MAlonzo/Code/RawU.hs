...
check_pdata_40 :: T_Tag_28 (T_Esc_24 MAlonzo.Code.Utils.T_DATA_718)
check_pdata_40 = TagData
check_value_42 ::
  T_Tag_28 (T_Esc_24 MAlonzo.Code.Utils.T_Value_890)
  ...
  = let v4 = coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8 in
    coe
      (case coe v0 of
         ...
         C_pdata_40
           -> case coe v2 of
                C_pdata_40 -> coe MAlonzo.Code.Utils.d_eqDATA_842 (coe v1) (coe v3)
                _ -> coe v4
         C_pair_48 v7 v8
           -> case coe v1 of
