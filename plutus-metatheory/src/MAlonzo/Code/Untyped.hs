...
data T__'8866'_14
  = C_'96'_18 AgdaAny | C_ƛ_20 T__'8866'_14 |
    ...
    C_delay_26 T__'8866'_14 | C_con_28 MAlonzo.Code.RawU.T_TmCon_204 |
      ...
      MAlonzo.Code.RawU.C_tmCon_208 v1 v2
        -> case coe v1 of
             ...
             MAlonzo.Code.Builtin.Signature.C_pair_24 v4 v5
               -> case coe v2 of
                    MAlonzo.Code.Utils.C__'44'__384 v6 v7
                      -> coe
                           MAlonzo.Code.Data.String.Base.d__'43''43'__20
                           ("(pair (" :: Data.Text.Text)
                           (coe
...
d_uglyTmConList_72 ::
  ...
  MAlonzo.Code.Utils.T_List_388 AgdaAny ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_uglyTmConList_72 v0 v1
  = case coe v1 of
      MAlonzo.Code.Utils.C_'91''93'_392 -> coe ("" :: Data.Text.Text)
      MAlonzo.Code.Utils.C__'8759'__394 v2 v3
        -> case coe v3 of
             MAlonzo.Code.Utils.C_'91''93'_392
               -> coe
                    d_uglyTmCon_68
                    (coe MAlonzo.Code.RawU.C_tmCon_208 (coe v0) (coe v2))
             MAlonzo.Code.Utils.C__'8759'__394 v4 v5
               -> coe
                    MAlonzo.Code.Data.String.Base.d__'43''43'__20
                    (d_uglyTmCon_68
                       (coe MAlonzo.Code.RawU.C_tmCon_208 (coe v0) (coe v2)))
...
d_showNat_120 = T.pack . show
-- Untyped.uglyBuiltin
d_uglyBuiltin_122 ::
  MAlonzo.Code.Builtin.T_Builtin_2 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_uglyBuiltin_122 v0
...
d_uglyList_126 ~v0 v1 = du_uglyList_126 v1
du_uglyList_126 ::
  [T__'8866'_14] -> MAlonzo.Code.Agda.Builtin.String.T_String_6
du_uglyList_126 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Data.String.Base.d__'43''43'__20
         (coe du_uglyList''_130 (coe v0)) ("]" :: Data.Text.Text))
-- Untyped.uglyList'
d_uglyList''_130 ::
  () -> [T__'8866'_14] -> MAlonzo.Code.Agda.Builtin.String.T_String_6
d_uglyList''_130 ~v0 v1 = du_uglyList''_130 v1
du_uglyList''_130 ::
  [T__'8866'_14] -> MAlonzo.Code.Agda.Builtin.String.T_String_6
du_uglyList''_130 v0
  = case coe v0 of
      ...
      (:) v1 v2
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             (coe du_ugly_134 (coe v1))
             (coe
                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                (" , " :: Data.Text.Text) (coe du_uglyList''_130 (coe v2)))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Untyped.ugly
d_ugly_134 ::
  () -> T__'8866'_14 -> MAlonzo.Code.Agda.Builtin.String.T_String_6
d_ugly_134 ~v0 v1 = du_ugly_134 v1
du_ugly_134 ::
  T__'8866'_14 -> MAlonzo.Code.Agda.Builtin.String.T_String_6
du_ugly_134 v0
  = case coe v0 of
      ...
      C_ƛ_20 v1
        -> coe
             ...
             (coe
                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                (coe du_ugly_134 (coe v1)) (")" :: Data.Text.Text))
      C__'183'__22 v1 v2
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             ("( " :: Data.Text.Text)
             (coe
                ...
                (coe
                   ...
                   (coe
                      MAlonzo.Code.Data.String.Base.d__'43''43'__20
                      (coe du_ugly_134 (coe v2)) (")" :: Data.Text.Text))))
      C_force_24 v1
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
      ...
      C_constr_34 v1 v2
        -> coe
             ...
             (coe
                ...
                (coe
                   MAlonzo.Code.Data.String.Base.d__'43''43'__20
                   (coe du_uglyList_126 (coe v2)) (")" :: Data.Text.Text)))
      C_case_40 v1 v2
        -> coe
             MAlonzo.Code.Data.String.Base.d__'43''43'__20
             ("(case " :: Data.Text.Text)
      ...
      C_builtin_44 v1
        -> coe
             ...
             (coe
                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                (d_uglyBuiltin_122 (coe v1)) (")" :: Data.Text.Text))
      C_error_46 -> coe ("error" :: Data.Text.Text)
      _ -> MAlonzo.RTE.mazUnreachableError
-- Untyped.extG
d_extG_168 ::
  () -> (AgdaAny -> Integer) -> Maybe AgdaAny -> Integer
d_extG_168 ~v0 v1 v2 = du_extG_168 v1 v2
du_extG_168 :: (AgdaAny -> Integer) -> Maybe AgdaAny -> Integer
du_extG_168 v0 v1
  = case coe v1 of
...
d_extricateUList_178 ::
  () ->
  (AgdaAny -> Integer) ->
  [T__'8866'_14] ->
  MAlonzo.Code.Utils.T_List_388 MAlonzo.Code.RawU.T_Untyped_210
d_extricateUList_178 ~v0 v1 v2 = du_extricateUList_178 v1 v2
du_extricateUList_178 ::
  (AgdaAny -> Integer) ->
  [T__'8866'_14] ->
  MAlonzo.Code.Utils.T_List_388 MAlonzo.Code.RawU.T_Untyped_210
du_extricateUList_178 v0 v1
  = case coe v1 of
      [] -> coe MAlonzo.Code.Utils.C_'91''93'_392
      (:) v2 v3
        -> coe
             MAlonzo.Code.Utils.C__'8759'__394
             (coe du_extricateU_182 (coe v0) (coe v2))
             (coe du_extricateUList_178 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Untyped.extricateU
d_extricateU_182 ::
  () ->
...
d_extricateU_182 ~v0 v1 v2 = du_extricateU_182 v1 v2
du_extricateU_182 ::
  (AgdaAny -> Integer) ->
  T__'8866'_14 -> MAlonzo.Code.RawU.T_Untyped_210
du_extricateU_182 v0 v1
  = case coe v1 of
      C_'96'_18 v2 -> coe MAlonzo.Code.RawU.C_UVar_212 (coe v0 v2)
      C_ƛ_20 v2
        -> coe
             MAlonzo.Code.RawU.C_ULambda_214
             (coe du_extricateU_182 (coe du_extG_168 (coe v0)) (coe v2))
      C__'183'__22 v2 v3
        -> coe
             MAlonzo.Code.RawU.C_UApp_216
             (coe du_extricateU_182 (coe v0) (coe v2))
             (coe du_extricateU_182 (coe v0) (coe v3))
      C_force_24 v2
        -> coe
        ...
        -> case coe v3 of
             ...
             (:) v4 v5
               -> coe
                    ...
                    (coe
                       MAlonzo.Code.Utils.C__'8759'__394
                       (coe du_extricateU_182 (coe v0) (coe v4))
                       (coe du_extricateUList_178 (coe v0) (coe v5)))
             _ -> MAlonzo.RTE.mazUnreachableError
      C_case_40 v2 v3
        -> coe
...
d_extricateU0_242 ::
  T__'8866'_14 -> MAlonzo.Code.RawU.T_Untyped_210
d_extricateU0_242 v0 = coe du_extricateU_182 erased (coe v0)
-- Untyped.extG'
d_extG''_248 ::
  () ->
  (Integer ->
...
d_extG''_248 ~v0 v1 v2 = du_extG''_248 v1 v2
du_extG''_248 ::
  (Integer ->
   MAlonzo.Code.Utils.T_Either_6
     MAlonzo.Code.Scoped.T_ScopeError_576 AgdaAny) ->
...
d_scopeCheckUList_258 ~v0 v1 v2 = du_scopeCheckUList_258 v1 v2
du_scopeCheckUList_258 ::
  (Integer ->
   MAlonzo.Code.Utils.T_Either_6
     MAlonzo.Code.Scoped.T_ScopeError_576 AgdaAny) ->
  MAlonzo.Code.Utils.T_List_388 MAlonzo.Code.RawU.T_Untyped_210 ->
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.Utils.C__'8759'__394 v2 v3
        -> coe
             ...
             (coe du_scopeCheckU_262 (coe v0) (coe v2))
             (coe
                (\ v4 ->
                   coe
                     MAlonzo.Code.Utils.du_eitherBind_42
                     (coe du_scopeCheckUList_258 (coe v0) (coe v3))
                     (coe
                        (\ v5 ->
                           coe
                             MAlonzo.Code.Utils.C_inj'8322'_14
...
d_scopeCheckU_262 ::
  ...
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Scoped.T_ScopeError_576 T__'8866'_14
d_scopeCheckU_262 ~v0 v1 v2 = du_scopeCheckU_262 v1 v2
du_scopeCheckU_262 ::
  (Integer ->
   MAlonzo.Code.Utils.T_Either_6
     MAlonzo.Code.Scoped.T_ScopeError_576 AgdaAny) ->
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.RawU.C_ULambda_214 v2
        -> coe
             ...
             (coe du_scopeCheckU_262 (coe du_extG''_248 (coe v0)) (coe v2))
        ...
        -> coe
             ...
             (coe
                (\ v4 ->
                   coe
                     MAlonzo.Code.Utils.du_eitherBind_42
                     (coe du_scopeCheckU_262 (coe v0) (coe v3))
                     (coe
                        (\ v5 ->
                           coe
                             MAlonzo.Code.Utils.C_inj'8322'_14
         ...
         MAlonzo.Code.RawU.C_ULambda_214 v3
           -> case coe v1 of
                MAlonzo.Code.RawU.C_ULambda_214 v4
                  -> coe d_decUTm_338 (coe v3) (coe v4)
                _ -> coe v2
           ...
           -> case coe v1 of
                MAlonzo.Code.RawU.C_UApp_216 v5 v6
                  -> coe
                       ...
                       (coe d_decUTm_338 (coe v3) (coe v5))
                       (coe d_decUTm_338 (coe v4) (coe v6))
                _ -> coe v2
...
d_buildDebruijnEncoding_374 ::
  () ->
  Integer ->
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Scoped.T_ScopeError_576 (Maybe AgdaAny)
d_buildDebruijnEncoding_374 ~v0 v1
  = du_buildDebruijnEncoding_374 v1
du_buildDebruijnEncoding_374 ::
  Integer ->
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Scoped.T_ScopeError_576 (Maybe AgdaAny)
du_buildDebruijnEncoding_374 v0
  = coe
      du_extG''_248
      (coe
         (\ v1 ->
...
d_toWellScoped_382 ::
  ...
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Scoped.T_ScopeError_576 T__'8866'_14
d_toWellScoped_382 ~v0 = du_toWellScoped_382
du_toWellScoped_382 ::
  MAlonzo.Code.RawU.T_Untyped_210 ->
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.Scoped.T_ScopeError_576 T__'8866'_14
du_toWellScoped_382
  = coe du_scopeCheckU_262 (coe du_buildDebruijnEncoding_374)
-- Untyped.make-integer
d_make'45'integer_384 ::
  MAlonzo.Code.Builtin.Signature.T__'8866''9839'_4
d_make'45'integer_384
  = coe
...
-- Untyped.con-integer
d_con'45'integer_388 :: () -> Integer -> T__'8866'_14
d_con'45'integer_388 ~v0 v1 = du_con'45'integer_388 v1
du_con'45'integer_388 :: Integer -> T__'8866'_14
du_con'45'integer_388 v0
  = coe
      C_con_28
      (coe
         MAlonzo.Code.RawU.C_tmCon_208 (coe d_make'45'integer_384) (coe v0))
