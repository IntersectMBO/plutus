...
d_certifyPass_26 ::
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.VerifiedCompilation.Trace.T_UncertifiedOptTag_4
    MAlonzo.Code.VerifiedCompilation.Trace.T_CertifiedOptTag_10 ->
  MAlonzo.Code.VerifiedCompilation.Trace.T_Hints_76 ->
  MAlonzo.Code.Untyped.T__'8866'_14 ->
  MAlonzo.Code.Untyped.T__'8866'_14 ->
...
d_certify_46 v0
  = case coe v0 of
      MAlonzo.Code.VerifiedCompilation.Trace.C_step_88 v1 v2 v3 v4
        -> let v5
                 = coe
                     d_certifyPass_26 v1 v2 v3
                     (MAlonzo.Code.VerifiedCompilation.Trace.d_head_94 (coe v4)) in
           coe
             (case coe v5 of
                ...
                _ -> MAlonzo.RTE.mazUnreachableError)
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_90 v1
        -> coe
             MAlonzo.Code.Utils.C_inj'8322'_14
...
d_checkScope'7511'_102 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_84 ->
  Maybe MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_84
                     ...
                     (coe
                        (\ v6 ->
                           coe
                             ...
                             (coe
                                MAlonzo.Code.VerifiedCompilation.Trace.C_step_88 (coe v1) (coe v2)
                                (coe v5) (coe v6))))))
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_90 v1
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
             ...
             (coe
                (\ v2 ->
                   coe
                     MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                     (coe MAlonzo.Code.VerifiedCompilation.Trace.C_done_90 (coe v2))))
      _ -> MAlonzo.RTE.mazUnreachableError
