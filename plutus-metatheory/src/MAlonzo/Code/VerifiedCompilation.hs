...
import qualified MAlonzo.Code.VerifiedCompilation.UConstantFold
...
d_certifyPass_26 ::
  MAlonzo.Code.Utils.T_Either_6
    MAlonzo.Code.VerifiedCompilation.Trace.T_UncertifiedOptTag_4
    MAlonzo.Code.VerifiedCompilation.Trace.T_CertifiedOptTag_12 ->
  MAlonzo.Code.VerifiedCompilation.Trace.T_Hints_146 ->
  MAlonzo.Code.Untyped.T__'8866'_14 ->
  MAlonzo.Code.Untyped.T__'8866'_14 ->
        ...
        -> case coe v2 of
             ...
             MAlonzo.Code.VerifiedCompilation.Trace.C_constantFoldT_28
               -> coe
                    MAlonzo.Code.VerifiedCompilation.Certificate.du_decider_192
                    (coe
                       MAlonzo.Code.VerifiedCompilation.UConstantFold.d_isUConstantFold'63'_262
                       (coe (0 :: Integer)))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_certify_46 v0
  = case coe v0 of
      MAlonzo.Code.VerifiedCompilation.Trace.C_step_158 v1 v2 v3 v4
        -> let v5
                 = coe
                     d_certifyPass_26 v1 v2 v3
                     (MAlonzo.Code.VerifiedCompilation.Trace.d_head_164 (coe v4)) in
           coe
             (case coe v5 of
                ...
                _ -> MAlonzo.RTE.mazUnreachableError)
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_160 v1
        -> coe
             MAlonzo.Code.Utils.C_inj'8322'_14
...
d_checkScope'7511'_102 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_154 ->
  Maybe MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_154
                     ...
                     (coe
                        (\ v6 ->
                           coe
                             ...
                             (coe
                                MAlonzo.Code.VerifiedCompilation.Trace.C_step_158 (coe v1) (coe v2)
                                (coe v5) (coe v6))))))
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_160 v1
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
             ...
             (coe
                (\ v2 ->
                   coe
                     MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                     (coe MAlonzo.Code.VerifiedCompilation.Trace.C_done_160 (coe v2))))
      _ -> MAlonzo.RTE.mazUnreachableError
