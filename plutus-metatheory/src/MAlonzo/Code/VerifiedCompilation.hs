...
d_certifyPass_26 v0 v1
  = case coe v0 of
      ...
      MAlonzo.Code.Utils.C_inj'8322'_14 v2
        -> case coe v2 of
             MAlonzo.Code.VerifiedCompilation.Trace.C_floatDelayT_10
               -> coe
                    ...
                    (coe
                       ...
                       (coe (0 :: Integer)))
             MAlonzo.Code.VerifiedCompilation.Trace.C_forceDelayT_12
               -> coe
                    MAlonzo.Code.VerifiedCompilation.Certificate.du_decider_192
                    (coe
                       MAlonzo.Code.VerifiedCompilation.UForceDelay.d_isForceDelay'63'_178
                       (coe (0 :: Integer)))
             MAlonzo.Code.VerifiedCompilation.Trace.C_forceCaseDelayT_14
               -> coe
                    MAlonzo.Code.VerifiedCompilation.Certificate.du_decider_192
                    (coe
                       MAlonzo.Code.VerifiedCompilation.UForceCaseDelay.d_isForceCaseDelay'63'_94
                       (coe (0 :: Integer)))
             MAlonzo.Code.VerifiedCompilation.Trace.C_caseReduceT_16
               -> coe
                    MAlonzo.Code.VerifiedCompilation.Certificate.du_decider_192
                    (coe
...
d_Certificate_34 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_78 -> ()
...
d_certify_46 v0
  = case coe v0 of
      MAlonzo.Code.VerifiedCompilation.Trace.C_step_82 v1 v2 v3 v4
        -> let v5
                 = coe
                     d_certifyPass_26 v1 v2 v3
                     (MAlonzo.Code.VerifiedCompilation.Trace.d_head_88 (coe v4)) in
           coe
             (case coe v5 of
                ...
                _ -> MAlonzo.RTE.mazUnreachableError)
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_84 v1
        -> coe
             MAlonzo.Code.Utils.C_inj'8322'_14
...
d_checkScope'7511'_102 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_78 ->
  Maybe MAlonzo.Code.VerifiedCompilation.Trace.T_Trace_78
                     ...
                     (coe
                        (\ v6 ->
                           coe
                             ...
                             (coe
                                MAlonzo.Code.VerifiedCompilation.Trace.C_step_82 (coe v1) (coe v2)
                                (coe v5) (coe v6))))))
      MAlonzo.Code.VerifiedCompilation.Trace.C_done_84 v1
        -> coe
             MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
             ...
             (coe
                (\ v2 ->
                   coe
                     MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                     (coe MAlonzo.Code.VerifiedCompilation.Trace.C_done_84 (coe v2))))
      _ -> MAlonzo.RTE.mazUnreachableError
