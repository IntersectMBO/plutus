...
du_'91''8776''93''45'injective_26 v0 v1 v2
  = coe
      ...
      v2
-- Relation.Binary.Construct.Add.Infimum.Equality._.≈∙-dec
...
-- Relation.Binary.Construct.Add.Infimum.Equality._.≈∙-refl
...
du_'8776''8729''45'substitutive_38 v0 v1 v2 v3 v4 v5
  = coe
      ...
      v1 v2 v3 v4 v5
-- Relation.Binary.Construct.Add.Infimum.Equality._.≈∙-sym
