...
d_showCertifiedOptTag_10 v0
  = case coe v0 of
      ...
      MAlonzo.Code.VerifiedCompilation.Trace.C_polyBuiltinT_28
...
d_numSites_178 v0 v1 v2 v3
  = case coe v2 of
      ...
      MAlonzo.Code.VerifiedCompilation.Trace.C_polyBuiltinT_28
        -> coe
             MAlonzo.Code.VerifiedCompilation.UCSE.du_polyNumSites_400 (coe v1)
             (coe v3)
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.Untyped.C_ƛ_20 v2
        -> coe
             addInt (coe (1 :: Integer))
             (coe
                d_termSize_214 (coe addInt (coe (1 :: Integer)) (coe v0)) (coe v2))
      MAlonzo.Code.Untyped.C__'183'__22 v2 v3
        -> coe
             addInt
             (coe
                addInt (coe (1 :: Integer)) (coe d_termSize_214 (coe v0) (coe v2)))
             (coe d_termSize_214 (coe v0) (coe v3))
      ...
      MAlonzo.Code.Untyped.C_constr_34 v2 v3
        -> coe
             addInt (coe (1 :: Integer))
             (coe d_termSize'7510''695'_218 (coe v0) (coe v3))
      MAlonzo.Code.Untyped.C_case_40 v2 v3
        -> coe
             ...
             (coe
                addInt (coe (1 :: Integer))
                (coe d_termSize'7510''695'_218 (coe v0) (coe v3)))
             (coe d_termSize_214 (coe v0) (coe v2))
...
d_termSize'7510''695'_218 ::
  Integer -> [MAlonzo.Code.Untyped.T__'8866'_14] -> Integer
d_termSize'7510''695'_218 v0 v1
  = case coe v1 of
      [] -> coe (0 :: Integer)
      (:) v2 v3
        -> coe
             addInt (coe d_termSize'7510''695'_218 (coe v0) (coe v3))
             (coe d_termSize_214 (coe v0) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- CertifierReport.showEvalResult
d_showEvalResult_240 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_EvalResult_122 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_showEvalResult_240 v0
  = case coe v0 of
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (d_showEvalResult_240 (coe v4)) (" (after)" :: Data.Text.Text))))
                _ -> coe v1
         _ -> coe v1)
-- CertifierReport.tail
d_tail_260 :: () -> [AgdaAny] -> [AgdaAny]
d_tail_260 ~v0 v1 = du_tail_260 v1
du_tail_260 :: [AgdaAny] -> [AgdaAny]
du_tail_260 v0
  = case coe v0 of
      [] -> coe v0
      (:) v1 v2 -> coe v2
...
d_reportPasses_270 ::
  ...
  [MAlonzo.Code.VerifiedCompilation.Trace.T_EvalResult_122] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_reportPasses_270 v0 v1 v2 v3
  = case coe v1 of
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   MAlonzo.Code.Data.Nat.Show.d_show_56
                                                   (d_termSize_214 (coe (0 :: Integer)) (coe v4)))
                                                (coe
                                                   MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                                   (" (before)" :: Data.Text.Text)
                                                   (coe
...
d_makeReport_292 v0 v1
  = coe
      ...
      (coe
         MAlonzo.Code.Data.String.Base.d__'43''43'__20 d_nl_6
         (coe
            MAlonzo.Code.Utils.du_either_22 (coe v0) (coe d_reportFailure_286)
            (coe
               (\ v2 ->
                  case coe v2 of
                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4
                      -> coe
                           d_reportPasses_270 (coe (1 :: Integer)) (coe v3) (coe v4) (coe v1)
                    _ -> MAlonzo.RTE.mazUnreachableError))))
