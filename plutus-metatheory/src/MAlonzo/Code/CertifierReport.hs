      ...
      MAlonzo.Code.VerifiedCompilation.Trace.C_applyToCaseT_20
        -> coe
             ("Transform multi-argument applications into case-constr form"
              ::
              Data.Text.Text)
      MAlonzo.Code.VerifiedCompilation.Trace.C_letFloatOutT_22
        -> coe ("Float bindings outwards" :: Data.Text.Text)
      MAlonzo.Code.VerifiedCompilation.Trace.C_unknown_24
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.VerifiedCompilation.d_hasRelation_16 (coe v4))
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ...
                                            (coe
                                               ...
                                               (d_termSize_212 (coe (0 :: Integer)) (coe v6)))
                                            (coe
                                               MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                               (" (before)" :: Data.Text.Text)
                                               (coe
