...
d_showCertifiedOptTag_10 v0
  = case coe v0 of
      MAlonzo.Code.VerifiedCompilation.Trace.C_floatDelayT_16
        -> coe ("Float Delay" :: Data.Text.Text)
      MAlonzo.Code.VerifiedCompilation.Trace.C_forceDelayT_18
        -> coe ("Force-Delay Cancellation" :: Data.Text.Text)
      MAlonzo.Code.VerifiedCompilation.Trace.C_forceCaseDelayT_20
...
d_showUncertifiedOptTag_12 v0
  = case coe v0 of
      ...
      MAlonzo.Code.VerifiedCompilation.Trace.C_cseT_12
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.Untyped.C_ƛ_20 v2
        -> coe
             addInt (coe (1 :: Integer))
             (coe
                d_termSize_204 (coe addInt (coe (1 :: Integer)) (coe v0)) (coe v2))
      MAlonzo.Code.Untyped.C__'183'__22 v2 v3
        -> coe
             addInt
             (coe
                addInt (coe (1 :: Integer)) (coe d_termSize_204 (coe v0) (coe v2)))
             (coe d_termSize_204 (coe v0) (coe v3))
      ...
      MAlonzo.Code.Untyped.C_constr_34 v2 v3
        -> coe
             addInt (coe (1 :: Integer))
             (coe d_termSize'7510''695'_208 (coe v0) (coe v3))
      MAlonzo.Code.Untyped.C_case_40 v2 v3
        -> coe
             ...
             (coe
                addInt (coe (1 :: Integer))
                (coe d_termSize'7510''695'_208 (coe v0) (coe v3)))
             (coe d_termSize_204 (coe v0) (coe v2))
...
d_termSize'7510''695'_208 ::
  Integer -> [MAlonzo.Code.Untyped.T__'8866'_14] -> Integer
d_termSize'7510''695'_208 v0 v1
  = case coe v1 of
      [] -> coe (0 :: Integer)
      (:) v2 v3
        -> coe
             addInt (coe d_termSize'7510''695'_208 (coe v0) (coe v3))
             (coe d_termSize_204 (coe v0) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- CertifierReport.showEvalResult
d_showEvalResult_230 ::
  MAlonzo.Code.VerifiedCompilation.Trace.T_EvalResult_134 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_showEvalResult_230 v0
  = case coe v0 of
                  ...
                  -> coe
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                (d_showEvalResult_230 (coe v4)) (" (after)" :: Data.Text.Text))))
                _ -> coe v1
         _ -> coe v1)
-- CertifierReport.tail
d_tail_250 :: () -> [AgdaAny] -> [AgdaAny]
d_tail_250 ~v0 v1 = du_tail_250 v1
du_tail_250 :: [AgdaAny] -> [AgdaAny]
du_tail_250 v0
  = case coe v0 of
      [] -> coe v0
      (:) v1 v2 -> coe v2
...
d_reportPasses_260 ::
  ...
  [MAlonzo.Code.VerifiedCompilation.Trace.T_EvalResult_134] ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_reportPasses_260 v0 v1 v2 v3
  = case coe v1 of
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            MAlonzo.Code.Data.Nat.Show.d_show_56
                                            (d_termSize_204 (coe (0 :: Integer)) (coe v6)))
                                         (coe
                                            MAlonzo.Code.Data.String.Base.d__'43''43'__20
                                            (" (before)" :: Data.Text.Text)
                                            (coe
...
d_makeReport_282 v0 v1
  = coe
      ...
      (coe
         MAlonzo.Code.Data.String.Base.d__'43''43'__20 d_nl_6
         (coe
            MAlonzo.Code.Utils.du_either_22 (coe v0) (coe d_reportFailure_276)
            (coe
               (\ v2 ->
                  case coe v2 of
                    MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4
                      -> coe
                           d_reportPasses_260 (coe (1 :: Integer)) (coe v3) (coe v4) (coe v1)
                    _ -> MAlonzo.RTE.mazUnreachableError))))
