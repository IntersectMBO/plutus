...
lemV M (V-I⇒ sha3-256 {as' = as'} (bubble {as = as} p) q) E with
  <>>-cancel-both' as _ ([] ∷ Term) _ p refl
... | _ ,, () ,, _
lemV .(ibuiltin verifyEd25519Signature) (V-I⇒ verifyEd25519Signature (start .(Term ∷ Term ∷ Term ∷ [])) base) E = step* refl base
lemV (ibuiltin verifyEd25519Signature · t) (V-I⇒ verifyEd25519Signature (bubble (start .(Term ∷ Term ∷ Term ∷ []))) (step .(start (Term ∷ Term ∷ Term ∷ [])) base vt)) E = step* refl (step* refl (step* (cong (stepV _) (dissect-lemma E (-· t))) (step** (lemV t vt (extEC E (_ ·-))) (step* (cong (stepV vt) (dissect-lemma E (_ ·-))) base))))
...
lemV (ibuiltin verifyEcdsaSecp256k1Signature · t) (V-I⇒ verify
EcdsaSecp256k1Signature (bubble (start .(Term ∷ Term ∷ Term ∷ []))) (step .(start (Term ∷ Term ∷ Term ∷ [])) base vt)) E = step* refl (step* refl (step* (cong (stepV _) (dissect-lemma E (-· t))) (step** (lemV t vt (extEC E (_ ·-))) (step* (cong (stepV vt) (dissect-lemma E (_ ·-))) base))))
...
lemV (ibuiltin verifySchnorrSecp256k1Signature · t) (V-I⇒ verify
SchnorrSecp256k1Signature (bubble (start .(Term ∷ Term ∷ Term ∷ []))) (step .(start (Term ∷ Term ∷ Term ∷ [])) base vt)) E = step* refl (step* refl (step* (cong (stepV _) (dissect-lemma E (-· t))) (step** (lemV t vt (extEC E (_ ·-))) (step* (cong (stepV vt) (dissect-lemma E (_ ·-))) base))))
