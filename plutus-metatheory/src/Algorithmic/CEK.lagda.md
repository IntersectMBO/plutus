...
BUILTIN insertCoin (base $ V-con ccy $ V-con tok $ V-con x $ V-con v) = inj₂ (V-con (insertCOIN ccy tok x v))
...
BUILTIN valueContains (base $ V-con v1 $ V-con v2) = inj₂ (V-con (valueCONTAINS v1 v2))
BUILTIN valueData (base $ V-con v)  = inj₂ (V-con (valueDATA v))
