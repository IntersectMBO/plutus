...
BUILTIN mkPairData {A} (app (app base (V-con (tmData x))) (V-con (tmData y))) = inj₁ A --unimplemented inj₂ (V-con (pairDATA x y))
BUILTIN constrData {A} (app (app base (V-con (tmInteger i))) (V-con xs)) = inj₁ A --unimplemented inj₂ (V-con (tmData (ConstrDATA i xs)))
BUILTIN mapData {A} (app base (V-con xs)) = inj₁ A --unimplemented inj₂ (V-con (tmData (MapDATA xs)))
BUILTIN listData {A} (app base (V-con xs)) = inj₁ A --unimplemented  inj₂ (V-con (tmData (ListDATA xs)))
