...
Plutus Core includes support for \emph{sized types} and \emph{size kinds} to facilitate reasoning about running time and memory usage of programs. This is important for blockchain applications, in which programs consume \emph{gas} during execution according to their computational resource consumption.
