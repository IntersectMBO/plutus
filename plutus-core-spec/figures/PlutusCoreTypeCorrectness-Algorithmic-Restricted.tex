...
\begin{figure*}[t]
    ...
    \begin{prooftree}
        ...
        \AxiomC{\(\typeBoundedMultistep{\textit{MAX}}{\subst{S}{\alpha}{T}}{R}\)}
        \RightLabel{inst}
    ...
    \begin{prooftree}
        ...
        \AxiomC{\(\typeBoundedMultistep{\textit{MAX}}{\subst{\fixT{\alpha}{S}}{\alpha}{S}}{R}\)}
        \RightLabel{unwrap}
    ...
    \begin{prooftree}
        ...
        \UnaryInfC{\(\typeBoundedMultistep{\textit{MAX}}{\subst{S_0, ..., S_m}{\alpha_0, ..., \alpha_m}{B_i}}{T_i}\)}
        \UnaryInfC{\(\hypJ{\Gamma}{\istermJ{M_i}{T'_i}}\)}
        \UnaryInfC{\(T_i \equiv T'_i\)}
        \UnaryInfC{\(\typeBoundedMultistep{\textit{MAX}}{\subst{S_0, ..., S_m}{\alpha_0, ..., \alpha_m}{C}}{R}\)}
        \alwaysSingleLine
        \RightLabel{builtin}
