...
\hline\\
        ...
        \texttt{divideInteger}     &  \sig{}{\integer, \integer}{\integer}  &  - & i_1 , i_2   & \operatorname{div}\ i_1\ i_2      & i_2 \not= 0\\
        \texttt{quotientInteger}   &  \sig{}{\integer, \integer}{\integer}  &  - & i_1 , i_2   & \operatorname{quot}\ i_1\ i_2     & i_2 \not= 0\\
        \texttt{remainderInteger}  &  \sig{}{\integer, \integer}{\integer}  &  - & i_1 , i_2   & \operatorname{rem} \ i_1 \ i_2    & i_2 \not= 0\\
        \texttt{modInteger}        &  \sig{}{\integer, \integer}{\integer}  &  - & i_1 , i_2   & \operatorname{mod} \ i_1 \ i_2    & i_2 \not= 0\\
        %&&\\
        ...
        \texttt{intToByteString}  &   \sig{}{\integer}{\str}  &  - & i           & \text{the binary representation} \\
                                                                              &&&&\quad \text{of $i$ as a bytestring} \\
        %&&\\
        ...
        \texttt{takeByteString}    &   \sig{}{\integer,\str}{\str}   & - &   i, b     & take \ i \  b\\
        \texttt{dropByteString}    &   \sig{}{\integer,\str}{\str}   & - &   i, b     & drop \ i \  b\\
        %&&\\
        ...
        \texttt{verifySignature}   &  \sig{}{}{\boolean}  &   -  & k, d, s           & \text{\true{} if the private key corresponding}\\
