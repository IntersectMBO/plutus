...
þ       \texttt{greaterThanEqualsInteger}   &  \sig{s :: size}{\integer_s, \integer_s}{\boolean}  &  s & s!i_0 , s!i_1   &   i_0 >= i_1\\
        ...
        \texttt{resizeInteger}   &  \sig{s_0 :: size, s_1 :: size}{size_{s_1},\integer_{s_0}}{\integer_{s_1}}  &   s_0, s_1   & \uniqmem{s_1}, s_0!i   & s_1!i & -2^{8s_1-1} \leq i < 2^{8s_1-1}\\
        \texttt{sizeOfInteger}   &  \sig{s :: size}{\integer_{s}}{size_{s}}                                   &   s          & s!i        & s\\
        %&&\\

        \texttt{intToByteString}  &   \sig{s_0 :: size, s_1 :: size}{size_{s_1},\integer_{s_0}}{\str_{s_1}}  &  s_0, s_1  & \uniqmem{s_1}, s_0!i           & \text{the binary representation of $i$} &-2^{8s_1-1} \leq i < 2^{8s_1-1}\\
        ...
        \texttt{resizeByteString}   &   \sig{s_0 :: size, s_1 :: size}{size_{s_1},\str_{s_0}}{\str_{s_1}}   &   s _0, s_1 & \uniqmem{s_1}, s_0!b   &   s_1!b & |b| \leq s_1\\
        %&&\\
