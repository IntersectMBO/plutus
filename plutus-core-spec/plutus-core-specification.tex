...
\usepackage[colorlinks=true,linkcolor=RoyalBlue,citecolor=ForestGreen,urlcolor=Plum]{hyperref}  % You're supposed to make this the final package
...
\section{Examples}
The section contains some relatively simple examples of Plutus Core
code.
...
\paragraph{Other examples.} The Plutus Core evaluator at
\url{https://github.com/input-output-hk/plutus/tree/master/plutus-exe}
...
it requires a stereotypical but somewhat complex \verb|ifix| analogue
of the $Z$ combinator in order to implement recursion).
