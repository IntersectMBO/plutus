...
\item The evaluation of $P$ terminates in the error state $\blacklozenge$ if
...
functions in the untyped CEK machine can deal with closures, and that
built-in evaluation commutes with type erasure and discharge of
