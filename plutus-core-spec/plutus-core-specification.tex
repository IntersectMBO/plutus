...
and System F (abs,inst). 
Higher kinds lead to computation in types so we need
...
\todokwxm{I'm unsettled by the fact that things like var, lam, wrap, builtin, and so on
are just in the normal text font.}
Type synthesis relies on type equivalence as defined in \ref{fig:type-equivalence}.
