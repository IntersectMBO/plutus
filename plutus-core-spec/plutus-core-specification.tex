...
We also consider validity of variable judgements in Figure
...
type variables defined further to the left in the context we explain
how to build up the judgement by weakening an existing one by
additional term and type variables on the right. These two styles of
rules for all combinations of term and type variables allow us to
variables in all positions in the context. This style of presentation
is analogous to how one might define instrinsically typed/kinded de
Bruijn indices.
