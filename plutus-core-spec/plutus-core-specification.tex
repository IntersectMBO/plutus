...
\begin{figure}[H]
    ...
    \begin{prooftree}
        \AxiomC{$cn$ has constant signature $\constsig{tcn}{s}$ in Fig. \ref{fig:constants}}
        \RightLabel{con}
    ...
    \begin{prooftree}
        \alwaysNoLine
        \AxiomC{$bn$ has signature $\sig{\alpha_0 :: K_0, ..., \alpha_m :: K_m}{B_0, ..., B_n}{C}$ in Fig. \ref{fig:builtins}}
