...
\noindent\blue{Should we give a more detailed explanation of why we do this? Do we want an example here?}
...
Execution of Plutus Core programs is performed by (possibly non-terminating) 
reduction of well-typed terms.  The reduction rules give us a fairly 
standard operational semantics, and ar contained in Figure~\ref{fig:term-reduction}.
