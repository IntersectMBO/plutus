...
-- Note that if you want to extend the set of types supporting default pretty-printing it's
-- not enough to provide a 'Pretty' instance for your type (such logic is hardly expressible
-- in the present Haskell).
