...
Builtin : naturalLit exclamation integerLit {% handleInteger (loc $1) (tkNat $1) (tkInt $3) }
...
Term : Name { Var (nameAttribute $1) $1 }
     ...
     | openParen builtin builtinVar closeParen { Constant $2 (BuiltinName (loc $3) (tkBuiltin $3)) }
