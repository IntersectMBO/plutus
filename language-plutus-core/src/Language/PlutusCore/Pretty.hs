...
instance Pretty (Builtin ann) where
    pretty = prettyClassicDef
instance PrettyClassic (Type tyname uni ann) => Pretty (Type tyname uni ann) where
    pretty = prettyClassicDef
instance PrettyClassic (Term tyname name uni ann) => Pretty (Term tyname name uni ann) where
    pretty = prettyClassicDef
instance PrettyClassic (Program tyname name uni ann) => Pretty (Program tyname name uni ann) where
    pretty = prettyClassicDef
