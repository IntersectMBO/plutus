...
-- -- | Get the 'Kind' of a 'TyConstant'.
-- kindOfTyConstant :: Some uni -> Kind ()
-- kindOfTyConstant = undefined
...
typeOfConstant :: SomeOf uni -> Normalized (Type TyName uni ())
...
typeOfBuiltinName :: Evaluable uni => BuiltinName -> Type TyName uni ()
...
inferTypeOfBuiltinM
    :: Evaluable uni => Builtin ann -> TypeCheckM uni ann (Normalized (Type TyName uni ()))
