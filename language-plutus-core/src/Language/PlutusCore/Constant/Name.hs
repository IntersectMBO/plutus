...
makeTypedBuiltinName :: KnownTypeScheme term args res => StaticBuiltinName -> TypedBuiltinName term args res
...
withTypedBuiltinName
    ...
    => StaticBuiltinName -> (forall args res. TypedBuiltinName term args res -> c) -> c
