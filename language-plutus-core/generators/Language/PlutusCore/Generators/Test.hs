...
getSampleTermValue
    :: (uni ~ DefaultUni, KnownType uni a)
    => TermGen uni a -> IO (TermOf uni (EvaluationResultDef uni))
...
getSampleProgramAndValue
    :: (uni ~ DefaultUni, KnownType uni a)
    => TermGen uni a -> IO (Program TyName Name uni (), EvaluationResultDef uni)
...
printSampleProgramAndValue :: KnownType DefaultUni a => TermGen DefaultUni a -> IO ()
printSampleProgramAndValue =
