    ...
    PamContractTerms {..} ->
        ...
        in
            case ev of
                ...
                PY_EVENT {..}  -> _POF_PY_PAM _PYTP o_rf_CURS o_rf_RRMO _PYRT _cPYRT r_CNTRL nt ipnr y_sd_t
                FP_EVENT {..}  -> _POF_FP_PAM _FEB _FER o_rf_CURS r_CNTRL nt fac y_sd_t
                PRD_EVENT {..} -> _POF_PRD_PAM o_rf_CURS r_CNTRL _PPRD ipac ipnr nt y_sd_t
