    ...
    in case contractType of
        ...
        LAM ->
            case ev of
                ...
                PR  -> _POF_PR_LAM o_rf_CURS ct_CNTRL nt nsc prnxt
                ...
                FP  -> _POF_FP_LAM (fromJust ct_FEB) (fromJust ct_FER) o_rf_CURS ct_CNTRL nt feac y_sd_t
        ...
        NAM ->
            case ev of
                ...
                FP  -> _POF_FP_NAM (fromJust ct_FEB) (fromJust ct_FER) o_rf_CURS ct_CNTRL nt feac y_sd_t
