...
module Language.PlutusCore.Merkle.Constant.Dynamic.Emit
    ( withEmit
    , EmitHandler (..)
    , feedEmitHandler
    , withEmitHandler
...
newtype EmitHandler r = EmitHandler
    { unEmitHandler :: DynamicBuiltinNameMeanings -> Term TyName Name Integer -> IO r
    }

feedEmitHandler :: Term TyName Name Integer -> EmitHandler r -> IO r
...
withEmitTerm
    :: KnownType a
    => (Term TyName Name Integer -> EmitHandler r1 -> IO r2)
    -> EmitHandler r1
    -> IO ([a], r2)
...
withEmitEvaluateBy
    :: KnownType a
    => Evaluator Term m
    -> (Term TyName Name Integer -> Term TyName Name Integer)
