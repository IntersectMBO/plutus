...
module Language.PlutusCore.Merkle.Constant.Dynamic.OnChain
    ( OnChain (..)
    , OnChainEvaluator
    , OnChainTransformer
    , OnChainHandler
...
import           Language.PlutusCore.Merkle.Constant.Dynamic.Call
import           Language.PlutusCore.Merkle.Constant.Dynamic.Emit
...
type OnChainEvaluator names f r =
    DynamicBuiltinNameMeanings -> OnChain names f TyName Name Integer -> r
...
dynamicEmit :: Term tyname name Integer
...
dynamicLog :: Term tyname name Integer
...
evaluateHandlersBy
    ...
    -> OnChain names f TyName Name Integer
    -> r
