...
module Language.PlutusCore.Erasure.Untyped.Pretty.Plc
    (
...
import           Language.PlutusCore.Erasure.Untyped.Pretty.Classic
import           Language.PlutusCore.Erasure.Untyped.Pretty.Readable
...
instance DefaultPrettyPlcStrategy (Term name a) =>
    PrettyBy PrettyConfigPlc (Term name a)
instance DefaultPrettyPlcStrategy (Program name a) =>
    PrettyBy PrettyConfigPlc (Program name a)
...
defPrettyConfigPlcReadable opts =
    PrettyConfigPlc opts . PrettyConfigPlcReadable $
        topPrettyConfigReadable defPrettyConfigName
...
debugPrettyConfigPlcReadable opts =
    PrettyConfigPlc opts . PrettyConfigPlcReadable $
        topPrettyConfigReadable debugPrettyConfigName
