...
\paragraph{Scripting.}
Ledgers without scripting functionality can only enable very simple applications.
...
The \gls{plutus-platform} requires a particular scripting model which is described in \cref{sec:eutxo}.
