...
const site_docs_delve_deeper_languages_md_122_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"delve-deeper/languages","title":"Overview of Languages Compiling to UPLC","description":"Untyped Plutus Core (UPLC) is the assembly-like language that runs in Cardano nodes for transaction validation.","source":"@site/docs/delve-deeper/languages.md","sourceDirName":"delve-deeper","slug":"/delve-deeper/languages","permalink":"/docs/delve-deeper/languages","draft":false,"unlisted":false,"editUrl":"https://github.com/IntersectMBO/plutus/edit/master/doc/docusaurus/docs/delve-deeper/languages.md","tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1},"sidebar":"tutorialSidebar","previous":{"title":"Delve Deeper","permalink":"/docs/category/delve-deeper"},"next":{"title":"Haddock Documentation","permalink":"/docs/delve-deeper/haddock-documentation"}}');
