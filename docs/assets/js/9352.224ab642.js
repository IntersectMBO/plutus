"use strict";
(globalThis["webpackChunkdocusaurus"] = globalThis["webpackChunkdocusaurus"] || []).push([[9352],{
...
/* harmony export */ });
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9069);
...
/* harmony import */ var _chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1570);
/* harmony import */ var _chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1730);
/* harmony import */ var _chunk_QR6OTTB3_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9636);
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4502);
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9069);
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    this.diagramId = "";
    ...
    this.funs = [];
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getDiagramTitle */ .ab;
  ...
  sanitizeText(txt) {
    return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .common_default */ .Y2.sanitizeText(txt, this.config);
  }
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_QR6OTTB3_mjs__WEBPACK_IMPORTED_MODULE_6__/* .isValidShape */ .aP)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(edge.start, edge.end, {
...
You have to call mermaid.initialize.`
  ...
  setClickFun(id, functionName, functionArgs) {
    if ((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    const tooltipElem = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_5__/* .createTooltip */ .Ck)();
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .clear */ .IU)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const flowchartConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().flowchart ?? {};
    const dir = rawDir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().direction ?? void 0 : void 0);
  ...
  getData() {
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .getEdgeId */ .rY)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .defaultConfig2 */ .ME.flowchart;
  }
};
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(async function(text, id, _version, diag, positions) {
  ...
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)();
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  ...
  await (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__/* .render */ .XX)(data4Layout, svg, positions);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupViewPortForSVG */ .P)(svg, padding, "flowchart", conf?.useMaxWidth || false);
}, "draw");
...
var createFlowDiagram = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)(({
  ...
  init: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__/* .__name */ .K)((cnf) => {
    ...
    const layout = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getUserDefinedConfig */ .TM)().layout ?? defaultLayout ?? cnf.layout;
    if (layout) {
      (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setConfig2 */ .XV)({ layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__/* .setConfig2 */ .XV)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
}), "createFlowDiagram");
