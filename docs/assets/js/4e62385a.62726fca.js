...
const site_docs_using_plinth_inspecting_md_4e6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"using-plinth/inspecting","title":"Inspecting Compilation and Compiled Code","description":"On this page, you’ll learn how to look into the compilation of Plutus Tx and the resulting compiled code, which you might want to do for reasons such as debugging and tuning.","source":"@site/docs/using-plinth/inspecting.md","sourceDirName":"using-plinth","slug":"/using-plinth/inspecting","permalink":"/docs/using-plinth/inspecting","draft":false,"unlisted":false,"editUrl":"https://github.com/IntersectMBO/plutus/edit/master/doc/docusaurus/docs/using-plinth/inspecting.md","tags":[],"version":"current","sidebarPosition":30,"frontMatter":{"sidebar_position":30},"sidebar":"tutorialSidebar","previous":{"title":"Special Functions and Types","permalink":"/docs/using-plinth/special-functions-and-types"},"next":{"title":"CLI tool for Plutus","permalink":"/docs/using-plinth/cli-plutus"}}');
