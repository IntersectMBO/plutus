...
const site_docs_delve_deeper_understanding_script_hashes_md_2ee_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"delve-deeper/understanding-script-hashes","title":"Understanding Script Hashes","description":"Script hashes are a core concept and play a vital role on Cardano.","source":"@site/docs/delve-deeper/understanding-script-hashes.md","sourceDirName":"delve-deeper","slug":"/delve-deeper/understanding-script-hashes","permalink":"/docs/delve-deeper/understanding-script-hashes","draft":false,"unlisted":false,"editUrl":"https://github.com/IntersectMBO/plutus/edit/master/doc/docusaurus/docs/delve-deeper/understanding-script-hashes.md","tags":[],"version":"current","sidebarPosition":20,"frontMatter":{"sidebar_position":20},"sidebar":"tutorialSidebar","previous":{"title":"Cost Model","permalink":"/docs/delve-deeper/cost-model"},"next":{"title":"Encoding Data Types in UPLC","permalink":"/docs/delve-deeper/encoding"}}');
...
const toc = [{
  ...
  "value": "Changing Plutus Tx compiler versions may lead to changed script hashes",
  "id": "changing-plutus-tx-compiler-versions-may-lead-to-changed-script-hashes",
  "level": 2
}];
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      id: "changing-plutus-tx-compiler-versions-may-lead-to-changed-script-hashes",
      children: "Changing Plutus Tx compiler versions may lead to changed script hashes"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Different Plutus Tx compiler versions may compile and optimize the same Plutus Tx code differently, leading to different UPLC programs and, therefore, different script hashes."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["If you plan to use your script in the future, the best approach is to save the compiled script in a blueprint file.\nFor further information, refer to ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/working-with-scripts/producing-a-blueprint",
        children: "Producing a Plutus contract blueprint"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "If you wish to compile your Plutus Tx code again in the future while ensuring the script hash remains unchanged, consider using Nix to lock the versions of all dependencies by pinning to a specific version of nixpkgs."
    })]
  });
}
