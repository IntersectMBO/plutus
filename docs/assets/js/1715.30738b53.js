"use strict";
(globalThis["webpackChunkdocusaurus"] = globalThis["webpackChunkdocusaurus"] || []).push([[1715],{
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(() => {
  const config = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)({
    ...
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__/* .random */ .yT)({ length: 7 });
}
...
var commit = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(function(commitDB) {
  ...
  const config = getConfig3();
  id = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(id, config);
  msg = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  const newCommit = {
...
var branch = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(function(branchDB) {
  ...
  name = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(name, getConfig3());
...
var merge = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((mergeDB) => {
  ...
  const config = getConfig3();
  otherBranch = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(customId, config);
  }
...
var cherryPick = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(function(cherryPickDB) {
  ...
  const config = getConfig3();
  sourceId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(sourceId, config);
  targetId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(tag, config));
  parentCommitId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(parentCommitId, config);
...
var checkout = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(function(branch2) {
  branch2 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(branch2, getConfig3());
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
  const { theme } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((commit2, pos, isParallelCommits) => {
  ...
  const useReduxGeometry = REDUX_GEOMETRY_THEMES.has((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().theme ?? "");
...
var drawArrow = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((svg, commitA, commitB, allCommits) => {
  const { theme: arrowTheme } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var drawBranches = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((svg, branches, gitGraphConfig, id) => {
  const { look, theme, themeVariables } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)(function(txt, id, ver, diagObj) {
  ...
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setupGraphViewbox2 */ .mj)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth);
}, "draw");
...
var genColor = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K)((options) => {
  const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
