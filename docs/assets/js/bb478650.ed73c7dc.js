...
const site_docs_delve_deeper_cost_model_md_bb4_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"delve-deeper/cost-model","title":"Cost Model","description":"The cost model is used to determine the portion of the transaction fee that accounts for Plutus script execution.","source":"@site/docs/delve-deeper/cost-model.md","sourceDirName":"delve-deeper","slug":"/delve-deeper/cost-model","permalink":"/docs/delve-deeper/cost-model","draft":false,"unlisted":false,"editUrl":"https://github.com/IntersectMBO/plutus/edit/master/doc/docusaurus/docs/delve-deeper/cost-model.md","tags":[],"version":"current","sidebarPosition":15,"frontMatter":{"sidebar_position":15},"sidebar":"tutorialSidebar","previous":{"title":"Plinth Compiler Options","permalink":"/docs/delve-deeper/plinth-compiler-options"},"next":{"title":"Understanding Script Hashes","permalink":"/docs/delve-deeper/understanding-script-hashes"}}');
