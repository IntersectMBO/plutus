"use strict";
(globalThis["webpackChunkdocusaurus"] = globalThis["webpackChunkdocusaurus"] || []).push([[7643,8401],{
...
// EXTERNAL MODULE: ./node_modules/@docusaurus/theme-classic/lib/theme/MDXComponents/index.js + 19 modules
var MDXComponents = __webpack_require__(4246);
// EXTERNAL MODULE: ./node_modules/@docusaurus/core/lib/client/exports/useDocusaurusContext.js
var useDocusaurusContext = __webpack_require__(7639);
...
const LiteralInclude=({file,title,start,end,language})=>{const{siteConfig}=(0,useDocusaurusContext/* default */.A)();const[loading,setLoading]=(0,react.useState)(true);const[error,setError]=(0,react.useState)("");const[codeString,setCodeString]=(0,react.useState)("");(0,react.useEffect)(()=>{// Track if the component is still mounted
...
const CsvTable=({file,widths,minWidth})=>{const{siteConfig}=(0,useDocusaurusContext/* default */.A)();const[loading,setLoading]=(0,react.useState)(true);const[error,setError]=(0,react.useState)("");const[tableData,setTableData]=(0,react.useState)([]);(0,react.useEffect)(()=>{// Track if the component is still mounted
