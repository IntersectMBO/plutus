  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "aws-lambda-haskell-runtime".revision = (((hackage."aws-lambda-haskell-runtime")."3.0.4").revisions).default;
        ...
        "optparse-generic".revision = (((hackage."optparse-generic")."1.4.3").revisions).default;
        ...
        "hspec-discover".revision = (((hackage."hspec-discover")."2.7.2").revisions).default;
        ...
        "inline-c".revision = (((hackage."inline-c")."0.9.1.0").revisions).default;
        ...
        "hspec-core".revision = (((hackage."hspec-core")."2.7.2").revisions).default;
