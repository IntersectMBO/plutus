  ...
  extras = hackage:
    {
      packages = {
        ...
        "data-hash" = (((hackage.data-hash)."0.2.0.1").revisions)."0277d99cb8b535ecc375c59e55f1c91faab966d9167a946ef18445dd468ba727";
        "equivalence" = (((hackage.equivalence)."0.3.5").revisions)."aedbd070b7ab5e58dd1678cd85607bc33cb9ff62331c1fa098ca45063b3072db";
        "geniplate-mirror" = (((hackage.geniplate-mirror)."0.7.7").revisions)."6a698c1bcec25f4866999001c4de30049d4f8f00ec83f8930cda2f767489c637";
        "STMonadTrans" = (((hackage.STMonadTrans)."0.4.4").revisions)."437eec4fdf5f56e9cd4360e08ed7f8f9f5f02ff3f1d634a14dbc71e890035387";
        ...
        marlowe-actus-theory = ./marlowe-actus-theory.nix;
        ...
        web-ghc = ./web-ghc.nix;
        Agda = ./.stack-to-nix.cache.0;
        purescript-bridge = ./.stack-to-nix.cache.1;
        servant-purescript = ./.stack-to-nix.cache.2;
        cardano-crypto = ./.stack-to-nix.cache.3;
        unlit = ./.stack-to-nix.cache.4;
        ...
        iohk-monitoring = ./.stack-to-nix.cache.26;
        tracer-transformers = ./.stack-to-nix.cache.27;
        lobemo-backend-ekg = ./.stack-to-nix.cache.28;
        };
      };
