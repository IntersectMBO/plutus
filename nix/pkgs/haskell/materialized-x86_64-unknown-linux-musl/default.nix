  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "STMonadTrans".revision = (((hackage."STMonadTrans")."0.4.4").revisions).default;
        ...
        "hlint".revision = (((hackage."hlint")."3.2.1").revisions).default;
        ...
        "github-webhooks".revision = (((hackage."github-webhooks")."0.15.0").revisions).default;
        ...
        "Agda".revision = (((hackage."Agda")."2.6.1.2").revisions).default;
        "Agda".flags.enable-cluster-counting = false;
        "Agda".flags.debug = false;
        "Agda".flags.cpphs = false;
  ...
  extras = hackage:
    {
      packages = {
        ...
        deployment-server = ./.plan.nix/deployment-server.nix;
        };
      };
  modules = [
    ({ lib, ... }:
