    ...
    components = {
      "library" = {
        ...
        modules = [
          ...
          "Language/UntypedPlutusCore/Evaluation/Machine/Cek/ExBudgetMode"
          "Language/UntypedPlutusCore/Evaluation/Machine/Cek/Internal"
          ...
          "Language/PlutusCore/Evaluation/Machine/ExBudget"
