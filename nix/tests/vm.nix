...
in
{
  ...
  all = pkgs.callPackage ./vm-tests/all.nix { inherit makeTest;inherit (plutus) plutus-playground marlowe-playground marlowe-dashboard web-ghc plutus-pab marlowe-app; };
}
