hackage:
  {
    packages = {
      ...
      "generic-deriving".revision = (((hackage."generic-deriving")."1.12.2").revisions).default;
      ...
      "auto-update".revision = (((hackage."auto-update")."0.1.4").revisions).default;
      ...
      "wai-app-static".revision = (((hackage."wai-app-static")."3.1.6.2").revisions).default;
      ...
      "conduit-extra".revision = (((hackage."conduit-extra")."1.3.0").revisions).default;
