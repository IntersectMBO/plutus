...
intervalTest domain' constraints expected = testCase testStr $
...
internalTests = testGroup "Tools: Intervals" [
  testGroup "gapsWithinRange"
    ...
    , intervalTest @Integer (-10000,10000) [NL 1 , NG 10, NEQ 2,NEQ 4,NEQ 8]
