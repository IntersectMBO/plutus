...
hsValidatorsAgreesAndPassAll :: [(ConstitutionValidator, CompiledCode ConstitutionValidator)]
                           -> V3.FakeProposedContext -> Property
hsValidatorsAgreesAndPassAll vs ctx = conjoin $ fmap (`hsValidatorsAgreesAndPass` ctx) vs

hsValidatorsAgreesAndErrAll :: [(ConstitutionValidator, CompiledCode ConstitutionValidator)]
                          -> V3.FakeProposedContext -> Property
hsValidatorsAgreesAndErrAll vs ctx = conjoin $ fmap (`hsValidatorsAgreesAndErr` ctx) vs

hsAgreesWithTxBool :: (ConstitutionValidator, CompiledCode ConstitutionValidator)
...
hsValidatorsAgreesAndErr :: (ConstitutionValidator, CompiledCode ConstitutionValidator)
                          -> V3.FakeProposedContext -> Property
...
hsValidatorsAgreesAndPass :: (ConstitutionValidator, CompiledCode ConstitutionValidator)
                           -> V3.FakeProposedContext -> Property
