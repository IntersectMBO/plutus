...
module Cardano.Constitution.Validator.Data.TestsCommon
    ( applyOnData
    , tryApplyOnData
    , allVldtrsErred
    , allVldtrsPassed
...
import Cardano.Constitution.Validator.Data.Common
...
allVldtrsErred, allVldtrsPassed
    :: (ToData ctx)
    => [ConstitutionValidator]
    -> ctx
    -> Property
...
unsafeRunCekRes :: (t ~ Term NamedDeBruijn DefaultUni DefaultFun ())
                => t -> t
