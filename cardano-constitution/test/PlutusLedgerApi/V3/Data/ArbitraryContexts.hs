...
import PlutusTx.Data.AssocMap as AssocMap
import PlutusTx.Data.AssocMap as Tx
...
instance Arbitrary ArbitraryContext where
    arbitrary = ArbitraryContext Haskell.<$> (V3.ScriptContext
...
arbitraryProposalProcedure = ProposalProcedure zero
...
arbitraryGovernanceAction = ParameterChange Nothing
...
treasuryWithdrawalsCtxGen = V3.ScriptContext
                         Haskell.<$> arbitraryTxInfo
                         Haskell.<*> arbitraryRedeemer
                         Haskell.<*> twInfo
...
twProposalProcedure = ProposalProcedure zero
                             Haskell.<$> arbitraryCredential
                             Haskell.<*> twAction

arbitraryChangedParameters :: Gen ChangedParameters
arbitraryChangedParameters = ChangedParameters Haskell.<$> frequency
    ...
    , (10, Tx.toBuiltinData
          ...
          . AssocMap.unsafeFromList . List.sortOn fst . AssocMap.toList
...
-}
mkSmallFakeProposal = mkFakeParameterChangeContext
                     . Haskell.pure
