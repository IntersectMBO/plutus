...
\author{
 Roman Kireev\inst{1}\orcidID{0000-0003-4687-2739}
\and Chad Nester\inst{2}
\and Michael Peyton Jones\inst{1}\orcidID{0000-0003-0602-1657}
...
The Agda code in this paper is available as a literate Agda file, and the Agda
compiler code is available as a separate artifact.
...
formalisation of a \FIR{} compiler in Agda (the complete source is included as an
artifact of this paper). The compiler includes the syntax, the type
