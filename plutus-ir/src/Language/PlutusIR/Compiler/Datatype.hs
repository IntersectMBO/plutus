...
-- @
mkDatatypeType :: Compiling m a => Recursivity -> PLCType a -> Datatype TyName Name (Provenance a) -> m (PLCRecType a)
...
-- @
mkConstructor :: Compiling m a => PLCRecType a -> Datatype TyName Name (Provenance a) -> Int -> m (PLCTerm a)
...
-- @
mkDestructor :: Compiling m a => PLCRecType a -> Datatype TyName Name (Provenance a) -> m (PLCTerm a)
