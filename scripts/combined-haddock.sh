...
# Due to our custom setup, creating haddock for the full plutus project is not trivial.
# This is mostly due to broken links point to the dist-newstyle folder and to various folders 
# in the /nix/store.
