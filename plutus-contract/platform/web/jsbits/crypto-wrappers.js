...
function h$getTmpBuffer(n, minSize) {
  ...
  if(sn < minSize) {
    if(sn > 0) {
      Module._free(h$buffers[n]);
    }
    h$buffers[n] = Module._malloc(2*minSize); // fixme 2* shouldn't be needed
...
/* SHA256 */
const h$sha256_ctx_size      = 192; // 168;
const h$sha256_digest_size   = 32;
...
function h$cryptonite_sha256_init(ctx_d, ctx_o) {
  ...
  Module._cryptonite_sha256_init(ctx_ptr);
...
function h$cryptonite_sha256_update(ctx_d, ctx_o, data_d, data_o, len) {
  ...
  Module._cryptonite_sha256_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha256_ctx_size);
}
...
function h$cryptonite_sha256_finalize(ctx_d, ctx_o, out_d, out_o) {
  ...
  Module._cryptonite_sha256_finalize(ctx_ptr, out_ptr);
  h$copyFromHeap(out_ptr, out_d, out_o, h$sha256_digest_size);
}

/* SHA512 */
const h$sha512_ctx_size      = 256; // 208; // 256?
const h$sha512_digest_size   = 64;
...
function h$cryptonite_sha512_init(ctx_d, ctx_o) {
  ...
  Module._cryptonite_sha512_init(ctx_ptr);
...
function h$cryptonite_sha512_update(ctx_d, ctx_o, data_d, data_o, len) {
  ...
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, h$sha512_ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  Module._cryptonite_sha512_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$sha512_ctx_size);
}
...
function h$cryptonite_sha512_finalize(ctx_d, ctx_o, out_d, out_o) {
  ...
  Module._cryptonite_sha512_finalize(ctx_ptr, out_ptr);
 ...
 */
const h$sha3_ctx_size_max    = 376; // maximum size
const h$sha3_digest_size_max = 64;  // maximum size
...
function h$cryptonite_sha3_init(ctx_d, ctx_o, hashlen) {
  ...
  Module._cryptonite_sha3_init(ctx_ptr, hashlen);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
}

function h$cryptonite_sha3_update() {
  h$logWrapper("h$cryptonite_sha3_update");
  var ctx_size = Math.min(h$sha3_ctx_size_max, ctx_d.len-ctx_o);
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, ctx_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  Module._cryptonite_sha3_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
}

function h$cryptonite_sha3_finalize(ctx_d, ctx_o, out_d, out_o) {
  h$logWrapper("h$cryptonite_sha3_finalize");
  var ctx_size = Math.min(h$sha3_ctx_size_max, ctx_d.len-ctx_o),
      digest_size = Math.min(h$sha3_digest_size_max,out_d.len-out_o);
  var ctx_ptr = h$getTmpBufferWith(0, ctx_d, ctx_o, ctx_size),
      out_ptr = h$getTmpBufferWith(1, out_d, out_o, digest_size);
  Module._cryptonite_sha512_finalize(ctx_ptr, out_ptr);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, ctx_size);
  h$copyFromHeap(out_ptr, out_d, out_o, digest_size);
}

/* BLAKE2B */

const h$blake2b_state_size = 248; // fixme, this number may be wrong for different hash sizes than the wallet uses
...
function h$cryptonite_blake2b_init(ctx_d, ctx_o, hashlen) {
  ...
  Module._cryptonite_blake2b_init(ctx_ptr, hashlen);
...
function h$cryptonite_blake2b_update(ctx_d, ctx_o, data_d, data_o, len) {
  ...
  var ctx_ptr  = h$getTmpBufferWith(0, ctx_d, ctx_o, h$blake2b_state_size),
      data_ptr = h$getTmpBufferWith(1, data_d, data_o, len);
  Module._cryptonite_blake2b_update(ctx_ptr, data_ptr, len);
  h$copyFromHeap(ctx_ptr, ctx_d, ctx_o, h$blake2b_state_size);
}
...
function h$cryptonite_blake2b_finalize(ctx_d, ctx_o, hashlen, out_d, out_o) {
  ...
  Module._cryptonite_blake2b_finalize(ctx_ptr, hashlen, out_ptr);
  h$copyFromHeap(out_ptr, out_d, out_o, hashlen);
}

/* ED25519 */
const h$ed25519_pk_size      = 32;
const h$ed25519_sk_size      = 64;
const h$ed25519_sig_size     = 64;
...
function h$cardano_crypto_ed25519_sign_open(m_d, m_o, mlen, pk_d, pk_o, sig_d, sig_o) {
  ...
  return Module._cardano_crypto_ed25519_sign_open(m_ptr, mlen, pk_ptr, sig_ptr);
}
...
function h$cardano_crypto_ed25519_sign(m_d, m_o, mlen, salt_d, salt_o, slen, sk_d, sk_o, pk_d, pk_o, sig_d, sig_o) {
  ...
  Module._cardano_crypto_ed25519_sign
...
function h$cardano_crypto_ed25519_publickey(sk_d, sk_o, pk_d, pk_o) {
  ...
  Module._cardano_crypto_ed25519_publickey(sk_ptr, pk_ptr);
...
function h$cardano_crypto_ed25519_point_add(pk1_d, pk1_o, pk2_d, pk2_o, res_d, res_o) {
  ...
  var r = Module._cardano_crypto_ed25519_point_add(pk1_ptr, pk2_ptr, res_ptr);
...
function h$cryptonite_fastpbkdf2_hmac_sha512( pw_d, pw_o, pw_len
  ...
  Module._cryptonite_fastpbkdf2_hmac_sha512(pw_ptr, pw_len, salt_ptr, salt_len, iterations, out_ptr, out_len);
  h$copyFromHeap(out_ptr, out_d, out_o, out_len);
}

/* wallet stuff */
const h$secret_key_seed_size = 32;
const h$chain_code_size = 32;
const h$public_key_size = 32;
const h$master_key_size = 96;
const h$encrypted_key_size = 64;
const h$full_key_size = h$encrypted_key_size + h$public_key_size + h$chain_code_size;
...
function h$wallet_encrypted_derive_public( pub_in_d, pub_in_o
  ...
  var r = Module._wallet_encrypted_derive_public(pub_in_ptr, cc_in_ptr, index, pub_out_ptr, cc_out_ptr, mode);
...
function h$wallet_encrypted_derive_private( in_d, in_o
  ...
  Module._wallet_encrypted_derive_private(in_ptr, pass_ptr, pass_len, index, out_ptr, mode);
...
function h$wallet_encrypted_sign( encrypted_key_d, encrypted_key_o
  ...
  Module._wallet_encrypted_sign(ec_ptr, pass_ptr, pass_len, data_ptr, data_len, sig_ptr);
  h$copyFromHeap(sig_ptr, sig_d, sig_o, h$ed25519_sig_size);
}
...
function h$wallet_encrypted_from_secret( pass_d, pass_o, pass_len
  ...
  var r = Module._wallet_encrypted_from_secret(pass_ptr, pass_len, seed_ptr, cc_ptr, ec_ptr);
...
function h$wallet_encrypted_change_pass( in_d, in_o
  ...
  Module._wallet_encrypted_change_pass(in_ptr, old_pass_ptr, old_pass_len, new_pass_ptr, new_pass_len, out_ptr);
  h$copyFromHeap(out_ptr, out_d, out_o, h$full_key_size);
}
...
function h$wallet_encrypted_new_from_mkg( pass_d, pass_o, pass_len
  ...
  var r = Module._wallet_encrypted_new_from_mkg(pass_ptr, pass_len, master_ptr, encrypted_ptr);
