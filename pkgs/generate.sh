...
pushd "${scriptDir}"
  ...
  runInShell "cabal2nix glibcLocales" "$(nix-build -A stack2nix --no-out-link -Q ../)/bin/stack2nix" --platform x86_64-linux --hackage-snapshot 2018-06-26T09:58:14Z -j8 --test --bench --no-indent ./.. > default.nix.new
