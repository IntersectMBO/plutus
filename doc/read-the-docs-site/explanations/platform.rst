...
- `The Plutus Application Framework <https://github.com/IntersectMBO/plutus-apps>`_: support for writing applications ("Plutus Applications") in a particular style
