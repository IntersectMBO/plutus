...
\setlength{\LTleft}{-22mm}  % Shift the table left a bit to centre it on the page
...
argument.  In Plutus V2 we require that the first argument lies between 0 and
255 (inclusive); in any other case an error will occur.
