...
in Section~\ref{sec:V1-built-in-types}.  For ease of reference we reproduce
...
Appendix~\ref{appendix:default-builtins-V1}.%
...
Section~\ref{sec:V1-built-in-types} that only constructor tags between 0 and
