...
\begin{figure}[H]
    ...
    \textrm{CEK value} & V &  ::= & \VCon{\tn}{c} \enspace | \enspace \VDelay{M}{\rho}
       \enspace| \enspace \VLamAbs{x}{M}{\rho} \enspace | \enspace \VBuiltin{b}{\repetition{V}}{\eta}\\
...
\nomenclature[Gb2a]{$f$}{CEK stack frame: $\inForceFrame, \inAppLeftFrame{(M,\rho)}, \inAppRightFrame{V}$}
