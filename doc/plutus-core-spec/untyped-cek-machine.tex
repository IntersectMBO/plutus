...
have chosen to keep the evaluator in the specification minimal because
optimisations are typically implementation-dependent and may or may not be
sensible depending on the implementation language and implementation strategy
