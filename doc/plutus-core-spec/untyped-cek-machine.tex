...
\begin{figure}[H]
    ...
    \textrm{CEK value} & V &  ::= & \VCon{\tn}{c} \enspace | \enspace \VDelay{M}{\rho}
       ...
       &&& | \enspace \VConstr{i}{V_0 \ldots V_n} \enspace | \enspace \VBuiltin{b}{\repetition{V}}{\eta}\\
...
\begin{figure}[H]
    ...
    \[\begin{array}{lrclr}
        \textrm{Frame} & f  & ::=   & \inForceFrame                                                       & \textrm{force}\\
                       ...
                       &    &       & \inConstrFrame{i}{(\repetition{M}, \rho)}{\repetition{V}}           & \textrm{constructor argument}\\
...
\inConstrFrame{i}{\repetition{V}}{} \cons s & \return V   &~\mapsto~&
                         s \return \VConstr{i}{\repetition{V} \cons V} \\
\inCaseFrame{(M_0 \ldots M_n, \rho)} \cons s & \return \VConstr{i}{V_0 \ldots V_m}   &~\mapsto~&
                         \inAppLeftFrame{V_m} \cons \ldots \cons \inAppLeftFrame{V_0} \cons s ;\rho \compute M_i\\
