...
\newcommand\arrayOf[1]{\mathtt{array}\,\mathtt{(}#1\mathtt{)}}
...
\newcommand{\EvalBuiltin}{\mathsf{EvalBuiltin}}
\newcommand{\EvalBuiltinCEK}{\mathsf{EvalBuiltin_{\,CEK}}}
\newcommand{\CaseCEK}{\mathsf{CaseBuiltin_{\,CEK}}}
...
\DeclareMathOperator{\maxbranch}{\mathsf{maxBranch}}
% ^ Maximum number of branches for casing on built-in values
\newcommand{\match}[1]{\ensuremath{\mathsf{match}_{#1}}}
% ^ Matching function for a built-in type
...
\newcommand\Earray{\overrightarrow{\mathsf{E}}}
...
\newcommand\Darray{\overrightarrow{\mathsf{D}}}
