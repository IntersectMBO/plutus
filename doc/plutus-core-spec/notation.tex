...
\begin{itemize}
  ...
  \item Given a set $X$, $X^*$ denotes the set of finite sequences of elements of $X$:
    ...
    $$
    Elements of $X^*$ and $X^+$ will usually be written using the usual tuple
    notation $(x_1, \ldots, x_n)$. The empty sequence (corresponding to the case
    $n=0$) will be written $()$.
    ...
    \nomenclature[Aa6]{$()$}{The empty sequence/tuple}
