...
\noindent\red{What is the return type of caseList/caseData?  Presumably it'll
  have to be an \textsf{ap}, but do we want the user to see this? Maybe we can
  say $\mathsf{ap}(\tau)$ to indicate that it's an ap which is expected to
  evaluate to a particular type.}
