...
Appendix~\ref{appendix:default-builtins-alonzo} for a description of the
built-in types and type operators available in the Alonzo release of Plutus
Core.%
...
Section~\ref{sec:alonzo-built-in-types} for suggested syntax for the built-in
types included in the Alonzo release.
