...
\section{Putus V3 Built-in Types and Functions}
...
notation, most of which is used only in this section.

\subsection{Built-in types}
\label{sec:V3-built-in-types}
Tables~\ref{table:V3-built-in-types} describes three new built-in
types.
...
\label{sec:V3-built-in-functions}
