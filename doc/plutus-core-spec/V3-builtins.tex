...
\section{PlutusV3 Built-in Types and Functions}
\label{appendix:default-builtins-V3}
PlutusV3 (not yet released on Cardano) will add support for
\begin{itemize}
...
Plutus Core will become available at the same time as PlutusV3.
...
In PlutusV1 and PlutusV2 the first argument of \texttt{consByteString} is an
arbitrary integer which will be reduced modulo 256 before being prepended to the
second argument.  In PlutusV3 we require that the first argument lies between 0
