...
For example, Batch 2 of builtins was introduced in \LL{PlutusV2} at protocol version 7.0, so it is also available in \LL{PlutusV2} at protocol versions after 7.0, and \LL{PlutusV3} at protocol versions after 9.0 (when \LL{PlutusV3} itself is first introduced).
