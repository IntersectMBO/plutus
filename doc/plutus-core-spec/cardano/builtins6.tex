...
%         \hline
        ...
        $ \begin{array}{ll}
         (\mathtt{false}, x) & \mapsto \dapp{x}{}\\
         (\mathtt{false}, (x,y)) & \mapsto \dapp{x}{}\\
         (\mathtt{true}, (x,y)) &\mapsto \dapp{y}{}
        \end{array}$
        }\\
%         \hline
        \ty{integer}
        ...
        {\renewcommand*{\arraystretch}{1}
        $\begin{array}{ll}
         (k, (x_0, ..., x_{n-1})) &\mapsto \dapp{x_k}{}\quad  \text{if $0 \leq k \leq n-1$}\\
        \end{array}$
        }\\
%         \hline
        $\ty{list}\,\tau$ &
        {\renewcommand*{\arraystretch}{1}
        $ \begin{array}{ll}
         ([x_1,x_2,\ldots,x_n], f) & \mapsto \dapp{f}{x_1,[x_2,\ldots,x_n]}   \quad (n \geq 1)\\
         ([x_1,x_2,\ldots,x_n], (f,g)) & \mapsto \dapp{f}{x_1,[x_2,\ldots,x_n]} \quad (n \geq 1)\\
         ([], [f,g]) & \mapsto \dapp{g}{}\\
        \end{array}$
        }\\
%         \hline
