...
then \texttt{(case $i$ $M_0$ ... $M_5$)} will cause the term $M_i$ to be
evaluated if $i$ lies between 0 and 5, with `(error)` occurring if $i<0$ or
$i>5$.  See Section~\ref{sec:cardano-builtins} for details of the types which
