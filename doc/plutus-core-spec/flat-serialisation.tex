...
denotes the universe of types defined in Appendices~\ref{appendix:default-builtins-alonzo},
\ref{appendix:default-builtins-vasil}, and~\ref{appendix:default-builtins-future}).
...
Section~\ref{sec:future-built-in-functions}, and decoding is similarly performed
via bytestrings using the $\uncompress$ functions.  We do not provide
...
any subsequent input is ingored.
...
Tables~\ref{table:builtin-tags-alonzo}, \ref{table:builtin-tags-vasil}, and~\ref{table:builtin-tags-future}.  We
...
\label{table:builtin-tags-future}
\end{table}
