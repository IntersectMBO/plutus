...
mentioned in Appendix~\ref{appendix:default-builtins-V1}. Recall that $\unutfeight$
...
denotes the universe of types defined in Appendices~\ref{appendix:default-builtins-V1},
...
Section~\ref{sec:V3-built-in-functions}, and decoding is similarly performed
...
\hline
\end{tabular}
\caption{Extra tags for V2 builtins}
