...
&  \Eterm(s, \Constr{i}{\repetition{t}})      &&= \Elist_{\mathsf{term}}(\E_{\N}(s \cdot \bits{1000}, i), \repetition{t}) \\
&  \Eterm(s, \Kase{u}{\repetition{t}})      &&= \Elist_{\mathsf{term}}(\ETerm(s \cdot \bits{1001}, u), \repetition{t})
\end{alignat*}
...
\begin{alignat*}{5}
  ...
  \Dterm(\bits{1000} \cdot s)  &= (s', \Constr{i}{\repetition{t}}) &&\quad \text{if } \D_{\N}(s) = (s', i) &&\ \text{and}\ \Dlist_{\mathsf{term}}(s') = (s'', \repetition{t})\\
  \Dterm(\bits{1001} \cdot s)  &= (s', \Kase{u}{\repetition{t}}) &&\quad \text{if } \Dterm(s) = (s', u) &&\ \text{and}\ \Dlist_{\mathsf{term}}(s') = (s'', \repetition{t})
\end{alignat*}
