...
\bigskip
\noindent For any Plutus Core term $M$, if evaluation according to these rules
terminates, the result is either \texttt{(error)} or a value. This holds without
any closedness or well-scopedness requirement; unbound variables simply cause an
