// AppendString plot configuration and rendering (3D)

// Configuration
const FUNCTION_NAME = 'AppendString';  // CSV uses PascalCase
const COST_MODEL_NAME = 'appendString';  // JSON uses camelCase
const ARITY = 2;
...
function updateInfoPanel() {
  ...
  // Update ranges for X and Y axes
  if (benchmarkData.length > 0) {
...
function renderPlot() {
  ...
  const layout = {
    ...
    scene: {
      xaxis: {
        title: 'String 1 size (characters)',
        gridcolor: '#E0E0E0'
      },
      yaxis: {
        title: 'String 2 size (characters)',
        gridcolor: '#E0E0E0'
      },
      zaxis: {
