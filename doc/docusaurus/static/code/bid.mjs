...
const utxos = await blockchainProvider.fetchAddressUTxOs(auctionValidatorAddress);
...
const tx = new Transaction({ initiator: wallet })
  ...
  .setTimeToExpire("59339374");

if (highestBidderAddress) {
  console.log(`SENDING LOVELACE to ${highestBidderAddress} in the amount of ${highestBidAmount}`)
  tx.sendLovelace(
