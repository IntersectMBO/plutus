...
evaluateScriptCounting = Internal.evaluateScriptCounting PlutusV3
...
evaluateScriptRestricting
    ...
    -> [PLC.Data]          -- ^ The arguments to the script
    -> (LogOutput, Either EvaluationError ExBudget)
evaluateScriptRestricting = Internal.evaluateScriptRestricting PlutusV3
...
mkEvaluationContext = tagWithParamNames @V3.ParamName
                    ...
                    >=> Internal.mkDynEvaluationContext Plutus.DefaultFunV2
