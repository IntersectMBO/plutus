...
module PlutusLedgerApi.Data.V2 (
  ...
  -- *** Credentials
  V1.StakingCredential (..), -- constructor exported for testing purposes
  pattern V1.StakingHash,
  pattern V1.StakingPtr,
  V1.Credential (..), -- constructor exported for testing purposes
  ...
  V1.Address (..), -- constructor exported for testing purposes
  pattern V1.Address,
