...
import PlutusLedgerApi.Test.V4.Data.EvaluationContext qualified as V4
...
tests =
  testNestedNamed
    ...
    [ embed $ testCase "length" do
        341 @=? length v1_ParamNames
        341 @=? length v2_ParamNames
        359 @=? length v3_ParamNames
        359 @=? length v4_ParamNames
