...
toolbox =
  xml [ id_ "actusBlocklyToolbox", style "display:none" ]
    [ category [ name "Contract Types", colour contractColour ] (map mkBlock contractTypes)
    , category [ name "Contract Terms", colour observationColour ] (map mkBlock observationTypes)
    , category [ name "Cycles", colour actionColour ] (map mkBlock actionTypes)
    , category [ name "Assertions", colour valueColour ] (map mkBlock valueTypes)
    ]
  where
