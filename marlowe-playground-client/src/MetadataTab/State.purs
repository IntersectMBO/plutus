...
carryMetadataAction action = do
  modifying (_contractMetadata) case action of
    ...
    SetSlotParameterDescription slotParam description -> over _slotParameterDescriptions $ OrderedMap.insert slotParam description
    DeleteSlotParameterDescription slotParam -> over _slotParameterDescriptions $ OrderedMap.delete slotParam
    ...
    DeleteValueParameterInfo valueParameterName -> over _valueParameterInfo $ OrderedMap.delete valueParameterName
