...
recValue =
  Committed <$> (string "Committed" **> idCommit)
    ...
    <**> value'
    <|> MulValue
    <$> (string "MulValue" **> value')
    <**> value'
    <|> DivValue
    <$> (string "DivValue" **> value')
    <**> value'
    <**> value'
    <|> ModValue
    ...
    <**> value'
    <|> ValueFromChoice
    <$> (string "ValueFromChoice" **> idChoice)
    <**> value'
    <|> ValueFromOracle
    <$> (string "ValueFromOracle" **> idOracle)
    <**> value'
  where
...
recObservation =
  BelowTimeout <$> (string "BelowTimeout" **> timeout)
    <|> AndObs
    <$> (string "AndObs" **> observation')
    <**> observation'
    <|> OrObs
    <$> (string "OrObs" **> observation')
    <**> observation'
    <|> NotObs
    <$> (string "NotObs" **> observation')
    <|> ChoseThis
    <$> (string "ChoseThis" **> idChoice)
    <**> choice
    <|> ChoseSomething
    <$> (string "ChoseSomething" **> idChoice)
    <|> ValueGE
    <$> (string "ValueGE" **> value')
    <**> value'
    <|> ValueGT
    <$> (string "ValueGT" **> value')
    <**> value'
    <|> ValueLT
    <$> (string "ValueLT" **> value')
    <**> value'
    <|> ValueLE
    <$> (string "ValueLE" **> value')
    <**> value'
    <|> ValueEQ
    <$> (string "ValueEQ" **> value')
    <**> value'
  where
...
recContract =
  Commit <$> (string "Commit" **> idAction)
    ...
    <**> contract'
    <|> Both
    <$> (string "Both" **> contract')
    <**> contract'
    <|> Choice
    <$> (string "Choice" **> observation')
    <**> contract'
    <**> contract'
    <|> When
    <$> (string "When" **> observation')
    <**> timeout
    <**> contract'
    <**> contract'
    <|> While
    <$> (string "While" **> observation')
    <**> timeout
    <**> contract'
    <**> contract'
    <|> Scale
