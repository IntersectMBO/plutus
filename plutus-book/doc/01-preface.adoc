...
This book aims to educate beginner Haskell developers on the fundamentals of
...
tangible use cases. This book will be continuously updated to sync with the latest version of
Plutus code.
‌
