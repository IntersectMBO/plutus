...
image::../images/vesting-actions1.png[]

image::../images/vesting-actions2.png[]

image::../images/vesting-actions3.png[]

image::../images/vesting-result1.png[]

image::../images/vesting-result2.png[]
