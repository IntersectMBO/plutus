...
Haskell program which will be compiled into Plutus Core (that usually to go
...
will run on the blockchain. Plutus Tx is
...
and we can
share types and definitions between the two.
