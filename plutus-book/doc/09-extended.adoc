...
we use and build on concepts and notation from the <<03-UTxO>> chapter.
...
- inside a transaction, validator scripts are stored as a finite map indexed by the hash of this script
