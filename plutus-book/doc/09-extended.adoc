...
this type of accounting, we refer the reader again to <<bibliography#bibliography>>.
...
scripts, see <<bibliography#bibliography>>.
...
* Multi-currency on the UTXO Ledger, see <<bibliography#bibliography>>
- An implementation of a script-based model for different types of
currency as well as non-fungible tokens on the mockchain
* A Formal Specification of a Multi-Signature Scheme Using Scripts, see <<bibliography#bibliography>>
