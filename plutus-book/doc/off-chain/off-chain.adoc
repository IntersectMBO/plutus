...
we make sure that it runa in different wallet implementations,
...
image:../images/myPayToWallet-action.png[]

image:../images/myPayToWallet-result.png[]
...
image:../images/trigger-actions.png[]

image:../images/trigger-result.png[]
