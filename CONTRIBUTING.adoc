...
** You can read the https://developers.cardano.org/docs/operate-a-stake-pool/node-operations/installing-cardano-node/[Cardano node documentation] to find out how to install these.
