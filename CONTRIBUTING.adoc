...
* Various `pre-commit` checks are in place to warn you about what the CI will probably warn you, were you to push the PR. If you want to skip these checks, turn them off with the `--no-verify` option in git. E.g., run `git commit --no-verify`.
