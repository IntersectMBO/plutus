...
5. Open a PR for updating the cabal files and the changelog files. Example: https://github.com/input-output-hk/plutus/pull/5452.
6. Once the PR is merged, 'Draft a new Release' with name `x.y.z.0` using https://github.com/input-output-hk/plutus/releases/new[Github's release interface]:
...
8. Once the CHaP PR has been merged, make a PR to update the version used in `cardano-ledger`. Example: https://github.com/input-output-hk/cardano-ledger/pull/3563.
