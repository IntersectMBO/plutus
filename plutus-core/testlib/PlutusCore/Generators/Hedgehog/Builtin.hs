...
import PlutusCore.Evaluation.Machine.ExMemoryUsage (IntegerCostedByNumBytes, IntegerCostedLiterally,
...
genConstant tr
    ...
    | Just HRefl <- eqTypeRep tr (typeRep @IntegerCostedByNumBytes) = genArbitraryBuiltin @Integer
