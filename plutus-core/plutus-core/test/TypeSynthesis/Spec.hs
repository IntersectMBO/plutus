...
test_typecheckDefaultFuns =
    ...
    testGroup "builtins" . pure $
        runTestNestedM ["plutus-core", "test", "TypeSynthesis", "Golden"] $ do
            for_ enumerate $ test_typecheckAllFun @DefaultFun "DefaultFun"
            for_ enumerate $ test_typecheckAllFun @ExtensionFun "ExtensionFun"
