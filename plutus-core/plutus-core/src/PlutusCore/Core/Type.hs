...
deriving anyclass instance
  (NFData tyname, NFData name, NFData fun, NFData ann, Everywhere uni NFData, Closed uni)
...
deriving anyclass instance
  (NFData tyname, NFData name, Everywhere uni NFData, NFData fun, NFData ann, Closed uni)
