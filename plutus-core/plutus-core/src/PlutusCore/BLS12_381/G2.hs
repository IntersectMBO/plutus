...
instance Flat Element where
    decode = do
        x <- decode
        case BLS12_381.deserialize @BLS12_381.Curve2 x of
             Left err -> fail $ show err
             Right e  -> pure $ Element e
    encode = encode . BLS12_381.serialize @BLS12_381.Curve2 . unElement
    size = size . serialise
...
serialise :: Element -> ByteString  -- 96 bytes
serialise (Element a) = BLS12_381.serialize @BLS12_381.Curve2 a

deserialise :: ByteString -> Either BLS12_381.BLSTError Element
deserialise = second Element . BLS12_381.deserialize @BLS12_381.Curve2
