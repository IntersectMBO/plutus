...
builtinMeaningsToTypes
    :: ( AsTypeError err term uni fun ann, ToKind uni, HasUniApply uni
       , MonadError err m, ToBuiltinMeaning uni fun
       )
...
inferKind
    :: (AsTypeError err term uni fun ann, ToKind uni, MonadError err m, MonadQuote m)
...
inferType
    :: ( AsTypeError err (Term TyName Name uni fun ()) uni fun ann, ToKind uni, HasUniApply uni
       , MonadError err m, MonadQuote m, GShow uni, GEq uni, Ix fun
       )
