...
runThreeArgumentModel (ModelThreeArgumentsAddedSizes (ModelAddedSizes intercept slope)) (ExMemory size1) (ExMemory size2) (ExMemory size3) =
    ceiling $ (1000 *) $ (fromInteger (size1 + size2 + size3)) * slope + intercept
