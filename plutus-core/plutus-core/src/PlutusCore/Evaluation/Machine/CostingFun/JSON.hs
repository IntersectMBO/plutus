...
deriving via
  ModelJSON "modelAddedSizes" ModelAddedSizes
  instance
...
deriving via
  ModelJSON "modelMultipliedSizes" ModelMultipliedSizes
  instance
...
deriving via
  ModelJSON "modelMinSize" ModelMinSize
  instance
...
deriving via
  ...
  instance
    ToJSON ModelMinSize
deriving via
  ModelJSON "modelMaxSize" ModelMaxSize
  instance
