...
testCekInternalFree = testGroup "cekInternal" $ fmap (uncurry testCase)
...
testDischargeFree = testGroup "discharge" $ fmap (uncurry testCase)
...
test_freevars = testGroup "FreeVars"
    [ testCekInternalFree
    , testDischargeFree
    ]
