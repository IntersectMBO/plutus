...
-- constructors] in 'UntypedPlutusCore.Core.Type'. They are never produced by any real program,
-- so hitting one here is an internal panic, not a normal evaluation failure.
