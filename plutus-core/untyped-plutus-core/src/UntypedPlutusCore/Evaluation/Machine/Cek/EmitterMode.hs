...
-- | No emitter.
noEmitter :: EmitterMode uni fun pat
noEmitter = EmitterMode $ \_ -> pure $ CekEmitterInfo (\_ -> pure ()) (pure mempty)

-- | Emits log only.
logEmitter :: EmitterMode uni fun pat
...
logWithTimeEmitter :: EmitterMode uni fun pat
...
logWithBudgetEmitter :: EmitterMode uni fun pat
...
logWithCallTraceEmitter :: EmitterMode uni fun pat
