    ...
    _ ->
      if isTrue# ((x# ># 0#) `andI#` (y# ># 0#))
        then maxBound
          ...
          if isTrue# ((x# <# 0#) `andI#` (y# <# 0#))
            then minBound
            else -- x and y have opposite signs, and yet we've overflowed, should
            -- be impossible
              overflowError
    ...
    _ ->
      if isTrue# ((x# >=# 0#) `andI#` (y# <# 0#))
        then maxBound
          ...
          if isTrue# ((x# <=# 0#) `andI#` (y# ># 0#))
            then minBound
            else -- x and y have the same sign, and yet we've overflowed, should
            -- be impossible
              overflowError
            ...
            then minBound
              ...
              if isTrue# ((x# <# 0#) `andI#` (y# ># 0#))
                then minBound
                  ...
                  if isTrue# ((x# <# 0#) `andI#` (y# <# 0#))
                    then maxBound
                    else -- Logically unreachable unless x or y is 0, in which case
