...
type CekEvaluationException uni fun = CekEvaluationExceptionCarrying (Plain Term uni fun)
...
-}
mkBuiltinApplication :: ExMemory -> BuiltinName -> Arity -> [TypeWithMem uni] -> [TermWithMem uni fun] -> TermWithMem uni fun
...
runCek
    ...
    -> CostModel
    -> Plain Term uni fun
    -> (Either (CekEvaluationException uni fun) (Plain Term uni fun), CekExBudgetState)
