...
modelFun <- function(path) {
   ...
   ## Round every coefficient up to a whole picosecond.
   round.up <- function (m) {
   ...
   ## one of them; the result is the intercept and slope of `multiplied_sizes`.  The slope is
   ## raised to the smallest value that covers every row.  Rows whose product is zero are
   ## dropped from the fit and kept in the model.
