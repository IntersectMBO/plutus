...
builtinMemoryModels =
  BuiltinCostModelBase
    ...
    , paramChooseData = Id $ ModelSevenArgumentsConstantCost 32
    ...
    , paramArrayData = Id $ ModelOneArgumentConstantCost 32
    , paramUnArrayData = Id $ ModelOneArgumentConstantCost 32
