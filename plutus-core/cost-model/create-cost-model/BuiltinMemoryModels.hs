...
builtinMemoryModels = BuiltinCostModelBase
  ...
  , paramBls12_381_G1_multiScalarMul     = Id $ ModelTwoArgumentsLinearInX $ OneVariableLinearFunction 1 (Slope g1MemSize)
  ...
  , paramBls12_381_G2_multiScalarMul     = Id $ ModelTwoArgumentsLinearInX $ OneVariableLinearFunction 1 (Slope g2MemSize)
