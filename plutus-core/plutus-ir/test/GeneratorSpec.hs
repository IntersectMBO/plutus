...
generators = return $ testGroup "generators"
  [ testProperty "prop_genKindCorrect"  $ withMaxSuccess 1000000000 (prop_genKindCorrect False)
  , testProperty "prop_shrinkTypeSound" $ prop_shrinkTypeSound
  , testProperty "prop_genTypeCorrect"  $ withMaxSuccess 10000000 (prop_genTypeCorrect False)
