...
tests =
  testNested ("AsData" </> "Budget") . pure $ testNestedGhc
    ...
    , goldenBudgetAndSize "onlyUseFirstField" (onlyUseFirstField `unsafeApplyCode` inp)
    ...
    , goldenBudgetAndSize "onlyUseFirstField-manual" (onlyUseFirstFieldManual `unsafeApplyCode` inp)
    ...
    , goldenBudgetAndSize "patternMatching" (patternMatching `unsafeApplyCode` inp)
    ...
    , goldenBudgetAndSize "recordFields" (recordFields `unsafeApplyCode` inp)
    ...
    , goldenBudgetAndSize "destructSum" (destructSum `unsafeApplyCode` inpSum)
    ...
    , goldenBudgetAndSize "destructSum-manual" (destructSumManual `unsafeApplyCode` inpSumM)
    ]
