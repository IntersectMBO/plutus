...
tests = testNested "LiftU" [
    ...
    , goldenUEval "monoInterop" [ getPlcNoAnn monoCase, liftProgramDef (Mono1 1 2) ]
    , goldenUPlc "poly" (liftProgramDef (Poly1 (1::Integer) (2::Integer)))
    , goldenUEval "polyInterop" [ getPlcNoAnn defaultCasePoly, liftProgramDef (Poly1 (1::Integer) (2::Integer)) ]
    , goldenUPlc "record" (liftProgramDef (MyMonoRecord 1 2))
    , goldenUEval "boolInterop" [ getPlcNoAnn andPlc, liftProgramDef True, liftProgramDef True ]
    , goldenUPlc "list" (liftProgramDef ([1]::[Integer]))
    , goldenUEval "listInterop" [ getPlcNoAnn listMatch, liftProgramDef ([1]::[Integer]) ]
